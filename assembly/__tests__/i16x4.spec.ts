...
function assertApiSync(): void {
  ...
  const extractSFns: FnExtractS[] = [
    ...
    i16x4_scalar.extract_lane_s,
  ];
  const extractUFns: FnExtractU[] = [
    i16x4.extract_lane_u,
    i16x4_scalar.extract_lane_u,
  ];
  const replaceFns: FnReplace[] = [
    i16x4.replace_lane,
    i16x4_scalar.replace_lane,
  ];
  const unaryVecFns: FnUnaryVec[] = [
    ...
    i16x4_scalar.extend_low_i8x8_s,
    i16x4.extend_low_i8x8_u,
    i16x4_scalar.extend_low_i8x8_u,
    i16x4.extend_high_i8x8_s,
    i16x4_scalar.extend_high_i8x8_s,
    i16x4.extend_high_i8x8_u,
    i16x4_scalar.extend_high_i8x8_u,
    i16x4.extadd_pairwise_i8x8_s,
    i16x4_scalar.extadd_pairwise_i8x8_s,
    i16x4.extadd_pairwise_i8x8_u,
    i16x4_scalar.extadd_pairwise_i8x8_u,
    i16x4.bitmask_lane,
    i16x4_scalar.bitmask_lane,
    i16x4.popcnt,
    i16x4_scalar.popcnt,
  ];
  const unaryBoolFns: FnUnaryBool[] = [
    i16x4.all_true,
    i16x4_scalar.all_true,
    i16x4.any_true,
    i16x4_scalar.any_true,
  ];
  ...
  const binaryVecFns: FnBinaryVec[] = [
    ...
    i16x4_scalar.avgr_u,
    i16x4.add_sat_s,
    i16x4_scalar.add_sat_s,
    i16x4.add_sat_u,
    i16x4_scalar.add_sat_u,
    i16x4.sub_sat_s,
    i16x4_scalar.sub_sat_s,
    i16x4.sub_sat_u,
    i16x4_scalar.sub_sat_u,
    i16x4.eq,
    i16x4_scalar.eq,
    i16x4.ne,
    i16x4_scalar.ne,
    ...
    i16x4_scalar.narrow_i32x2_s,
    i16x4.narrow_i32x2_u,
    i16x4_scalar.narrow_i32x2_u,
    i16x4.q15mulr_sat_s,
    i16x4_scalar.q15mulr_sat_s,
    i16x4.extmul_low_i8x8_s,
    i16x4_scalar.extmul_low_i8x8_s,
    i16x4.extmul_low_i8x8_u,
    i16x4_scalar.extmul_low_i8x8_u,
    i16x4.extmul_high_i8x8_s,
    i16x4_scalar.extmul_high_i8x8_s,
    i16x4.extmul_high_i8x8_u,
    i16x4_scalar.extmul_high_i8x8_u,
    i16x4.relaxed_q15mulr_s,
    i16x4_scalar.relaxed_q15mulr_s,
    i16x4.relaxed_dot_i8x8_i7x8_s,
    i16x4_scalar.relaxed_dot_i8x8_i7x8_s,
  ];
  ...
  const laneSelectFns: FnLaneSelect[] = [
    ...
    i16x4_scalar.relaxed_laneselect,
  ];
...
describe("i16x4", () => {
  ...
  test("partial load/store", () => {
    ...
    src[4] = 5000;
    src[5] = 6000;
    const loaded = i16x4.loadPartial(
  ...
  test("full scalar parity", () => {
    ...
    for (let run = 0; run < 256; run++) {
      ...
      if (
        !check32(
          i16x4.extract_lane_s(a, idx),
          i16x4_scalar.extract_lane_s(a, idx),
        )
      )
        return;
      if (
        !check32(
          i16x4.extract_lane_u(a, idx),
          i16x4_scalar.extract_lane_u(a, idx),
        )
      )
        return;
      if (
        !check64(
          i16x4.replace_lane(a, idx, laneVal),
          i16x4_scalar.replace_lane(a, idx, laneVal),
        )
      )
        return;
      ...
      if (
        !check64(i16x4.narrow_i32x2_s(c, d), i16x4_scalar.narrow_i32x2_s(c, d))
      )
        return;
      if (
        !check64(i16x4.narrow_i32x2_u(c, d), i16x4_scalar.narrow_i32x2_u(c, d))
      )
        return;
      if (
        !check64(i16x4.extend_low_i8x8_s(a), i16x4_scalar.extend_low_i8x8_s(a))
      )
        return;
      if (
        !check64(i16x4.extend_low_i8x8_u(a), i16x4_scalar.extend_low_i8x8_u(a))
      )
        return;
      if (
        !check64(
          i16x4.extend_high_i8x8_s(a),
          i16x4_scalar.extend_high_i8x8_s(a),
        )
      )
        return;
      if (
        !check64(
          ...
          i16x4_scalar.extend_high_i8x8_u(a),
        )
      )
        return;
      if (
        !check64(
          ...
          i16x4_scalar.extadd_pairwise_i8x8_s(a),
        )
      )
        return;
      if (
        !check64(
          ...
          i16x4_scalar.extadd_pairwise_i8x8_u(a),
        )
      )
        return;
      if (!check64(i16x4.q15mulr_sat_s(a, b), i16x4_scalar.q15mulr_sat_s(a, b)))
        return;
      if (
        !check64(
          i16x4.extmul_low_i8x8_s(a, b),
          i16x4_scalar.extmul_low_i8x8_s(a, b),
        )
      )
        return;
      if (
        !check64(
          ...
          i16x4_scalar.extmul_low_i8x8_u(a, b),
        )
      )
        return;
      if (
        !check64(
          ...
          i16x4_scalar.extmul_high_i8x8_s(a, b),
        )
      )
        return;
      if (
        !check64(
          ...
          i16x4_scalar.extmul_high_i8x8_u(a, b),
        )
      )
        return;
      if (
        !check64(
          i16x4.shuffle(a, b, l0, l1, l2, l3),
          i16x4_scalar.shuffle(a, b, l0, l1, l2, l3),
        )
      )
        return;
      if (
        !check64(
          i16x4.relaxed_laneselect(a, b, m),
          i16x4_scalar.relaxed_laneselect(a, b, m),
        )
      )
        return;
      if (
        !check64(
          i16x4.relaxed_q15mulr_s(a, b),
          i16x4_scalar.relaxed_q15mulr_s(a, b),
        )
      )
        return;
      if (
        !check64(
          i16x4.relaxed_dot_i8x8_i7x8_s(a, b),
          i16x4_scalar.relaxed_dot_i8x8_i7x8_s(a, b),
        )
      )
        return;
      completedRuns++;
