...
@inline function relaxedDotAddHalf(a: u64, b: u64, c: u64): u64 {
  ...
  for (let lane = 0; lane < 2; lane++) {
    ...
    for (let byte = 0; byte < 4; byte++) {
      ...
      sum +=
        ((a >> shift) as u8 as i8 as i32) * ((b >> shift) as u8 as i8 as i32);
    }
...
describe("v128 adaptive SIMD/SWAR dispatcher", () => {
  test("integer operations match independent v64 chunks", () => {
    ...
    for (let run = 0; run < 256; run++) {
      ...
      mismatches |= pairMatches(
        v128_swar.add<i8>(aLo, aHi, bLo, bHi),
        v64.add<i8>(aLo, bLo),
        v64.add<i8>(aHi, bHi),
      )
        ? 0
        : 1;
      mismatches |= pairMatches(
        v128_swar.sub<i16>(aLo, aHi, bLo, bHi),
        v64.sub<i16>(aLo, bLo),
        v64.sub<i16>(aHi, bHi),
      )
        ? 0
        : 2;
      mismatches |= pairMatches(
        v128_swar.mul<i32>(aLo, aHi, bLo, bHi),
        v64.mul<i32>(aLo, bLo),
        v64.mul<i32>(aHi, bHi),
      )
        ? 0
        : 4;
      mismatches |= pairMatches(
        v128_swar.min<i8>(aLo, aHi, bLo, bHi),
        v64.min<i8>(aLo, bLo),
        v64.min<i8>(aHi, bHi),
      )
        ? 0
        : 8;
      mismatches |= pairMatches(
        v128_swar.max<u16>(aLo, aHi, bLo, bHi),
        v64.max<u16>(aLo, bLo),
        v64.max<u16>(aHi, bHi),
      )
        ? 0
        : 16;
      mismatches |= pairMatches(
        v128_swar.add_sat<i8>(aLo, aHi, bLo, bHi),
        v64.add_sat<i8>(aLo, bLo),
        v64.add_sat<i8>(aHi, bHi),
      )
        ? 0
        : 32;
      mismatches |= pairMatches(
        v128_swar.sub_sat<u16>(aLo, aHi, bLo, bHi),
        v64.sub_sat<u16>(aLo, bLo),
        v64.sub_sat<u16>(aHi, bHi),
      )
        ? 0
        : 64;
      mismatches |= pairMatches(
        v128_swar.shl<i32>(aLo, aHi, shift),
        v64.shl<i32>(aLo, shift),
        v64.shl<i32>(aHi, shift),
      )
        ? 0
        : 128;
      mismatches |= pairMatches(
        v128_swar.shr<u32>(aLo, aHi, shift),
        v64.shr<u32>(aLo, shift),
        v64.shr<u32>(aHi, shift),
      )
        ? 0
        : 256;
      mismatches |= pairMatches(
        v128_swar.eq<i64>(aLo, aHi, bLo, bHi),
        v64.eq<i64>(aLo, bLo),
        v64.eq<i64>(aHi, bHi),
      )
        ? 0
        : 512;
      mismatches |= pairMatches(
        v128_swar.lt<u32>(aLo, aHi, bLo, bHi),
        v64.lt<u32>(aLo, bLo),
        v64.lt<u32>(aHi, bHi),
      )
        ? 0
        : 1024;
      mismatches |= pairMatches(
        v128_swar.le<i16>(aLo, aHi, bLo, bHi),
        v64.le<i16>(aLo, bLo),
        v64.le<i16>(aHi, bHi),
      )
        ? 0
        : 2048;
      mismatches |= pairMatches(
        v128_swar.lt<u64>(aLo, aHi, bLo, bHi),
        v64.lt<u64>(aLo, bLo),
        v64.lt<u64>(aHi, bHi),
      )
        ? 0
        : 16384;
      mismatches |= pairMatches(
        v128_swar.le<u64>(aLo, aHi, bLo, bHi),
        v64.le<u64>(aLo, bLo),
        v64.le<u64>(aHi, bHi),
      )
        ? 0
        : 32768;
      mismatches |=
        v128_swar.any_true(aLo, aHi) == (aLo != 0 || aHi != 0) ? 0 : 4096;
      mismatches |=
        v128_swar.bitmask<i32>(aLo, aHi) ==
        (v64.bitmask<i32>(aLo) | (v64.bitmask<i32>(aHi) << 2))
          ? 0
          : 8192;
  ...
  test("register VM inherits the adaptive dispatcher and aliases safely", () => {
    const aLo: u64 = 0x807f0100fffefdfc,
      aHi: u64 = 0x0102030405060708;
    const bLo: u64 = 0x0101010101010101,
      bHi: u64 = 0xffffffffffffffff;
  ...
  test("relaxed byte dot and dot-add preserve their result lane shapes", () => {
    ...
    for (let run = 0; run < 256; run++) {
      ...
      const actualAddLo = v128_swar.relaxed_dot_add<i8>(
        aLo,
        aHi,
        bLo,
        bHi,
