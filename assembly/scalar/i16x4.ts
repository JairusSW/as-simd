export namespace i16x4_scalar {
  ...
  export function shl(a: u64, b: i32): u64 {
    const shift = b & 15;
    return (
      ((a & (((0xffff >> shift) as u64) * 0x0001000100010001)) << shift) &
      0xffffffffffffffff
    );
  }
  ...
  export function shr_u(a: u64, b: i32): u64 {
    const shift = b & 15;
    return (
      (a & ((((0xffff << shift) & 0xffff) as u64) * 0x0001000100010001)) >>
      shift
    );
  }
  ...
  export function bitmask_lane(a: u64): u64 {
    return pack4(
      get16u(a, 0) != 0 ? 0x8000 : 0,
      get16u(a, 1) != 0 ? 0x8000 : 0,
      get16u(a, 2) != 0 ? 0x8000 : 0,
      get16u(a, 3) != 0 ? 0x8000 : 0,
    );
  }
  ...
  export function eq(a: u64, b: u64): u64 {
    return pack4(
      cmp_mask16(get16u(a, 0) == get16u(b, 0)),
      cmp_mask16(get16u(a, 1) == get16u(b, 1)),
      cmp_mask16(get16u(a, 2) == get16u(b, 2)),
      cmp_mask16(get16u(a, 3) == get16u(b, 3)),
    );
  }
  ...
  export function lt_s(a: u64, b: u64): u64 {
    return pack4(
      cmp_mask16(get16s(a, 0) < get16s(b, 0)),
      cmp_mask16(get16s(a, 1) < get16s(b, 1)),
      cmp_mask16(get16s(a, 2) < get16s(b, 2)),
      cmp_mask16(get16s(a, 3) < get16s(b, 3)),
    );
  }
  ...
  export function q15mulr_sat_s(a: u64, b: u64): u64 {
    return pack4(
      sat_i32_to_i16_s(
        ((get16s(a, 0) as i32) * (get16s(b, 0) as i32) + 0x4000) >> 15,
      ) as u16,
      sat_i32_to_i16_s(
        ((get16s(a, 1) as i32) * (get16s(b, 1) as i32) + 0x4000) >> 15,
      ) as u16,
      sat_i32_to_i16_s(
        ((get16s(a, 2) as i32) * (get16s(b, 2) as i32) + 0x4000) >> 15,
      ) as u16,
      sat_i32_to_i16_s(
        ((get16s(a, 3) as i32) * (get16s(b, 3) as i32) + 0x4000) >> 15,
      ) as u16,
    );
  }
  ...
  export function relaxed_dot_i8x8_i7x8_s(a: u64, b: u64): u64 {
    return pack4(
      ((get8s(a, 0) as i16) * (get8s(b, 0) as i16) +
        (get8s(a, 1) as i16) * (get8s(b, 1) as i16)) as u16,
      ((get8s(a, 2) as i16) * (get8s(b, 2) as i16) +
        (get8s(a, 3) as i16) * (get8s(b, 3) as i16)) as u16,
      ((get8s(a, 4) as i16) * (get8s(b, 4) as i16) +
        (get8s(a, 5) as i16) * (get8s(b, 5) as i16)) as u16,
      ((get8s(a, 6) as i16) * (get8s(b, 6) as i16) +
        (get8s(a, 7) as i16) * (get8s(b, 7) as i16)) as u16,
    );
  }
}
