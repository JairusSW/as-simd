...
// @ts-expect-error: decorator
@inline function mul_split16(a: u64, b: u64): u64 { const p0 = (((a & 0xff) * (b & 0xff)) & 0xff) | (((((a >> 8) & 0xff) * ((b >> 8) & 0xff)) & 0xff) << 8); const p1 = (((((a >> 16) & 0xff) * ((b >> 16) & 0xff)) & 0xff) | (((((a >> 24) & 0xff) * ((b >> 24) & 0xff)) & 0xff) << 8)) << 16; const p2 = (((((a >> 32) & 0xff) * ((b >> 32) & 0xff)) & 0xff) | (((((a >> 40) & 0xff) * ((b >> 40) & 0xff)) & 0xff) << 8)) << 32; const p3 = (((((a >> 48) & 0xff) * ((b >> 48) & 0xff)) & 0xff) | (((((a >> 56) & 0xff) * ((b >> 56) & 0xff)) & 0xff) << 8)) << 48; return p0 | p1 | p2 | p3; }
// @ts-expect-error: decorator
@inline function check(a: u64, b: u64): bool { const expected = i8x8_scalar.mul(a, b); const lib = i8x8.mul(a, b); const current = mul_current(a, b); const split32 = mul_split32(a, b); const split16 = mul_split16(a, b); if (lib != expected || current != expected || split32 != expected || split16 != expected) { expect<u64>(lib).toBe(expected); expect<u64>(current).toBe(expected); expect<u64>(split32).toBe(expected); expect<u64>(split16).toBe(expected); return false; } return true; }
