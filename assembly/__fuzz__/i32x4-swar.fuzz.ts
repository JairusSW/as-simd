...
fuzz("i32x4_swar parity vs i32x4", (seedValue: i32): bool => {
  ...
  if (!checkV128(pair(i32x4_swar.dot_i16x8_s(aLo, aHi, bLo, bHi)), i32x4.dot_i16x8_s(a, b))) return false;
  ...
  if (!checkBool(i32x4_swar.any_true(aLo, aHi), v128.any_true(a))) return false;
  ...
  if (!checkV128(pair(i32x4_swar.lt_u(aLo, aHi, bLo, bHi)), i32x4.lt_u(a, b))) return false;
  if (!checkV128(pair(i32x4_swar.le_s(aLo, aHi, bLo, bHi)), i32x4.le_s(a, b))) return false;
  if (!checkV128(pair(i32x4_swar.le_u(aLo, aHi, bLo, bHi)), i32x4.le_u(a, b))) return false;
  if (!checkV128(pair(i32x4_swar.gt_s(aLo, aHi, bLo, bHi)), i32x4.gt_s(a, b))) return false;
  if (!checkV128(pair(i32x4_swar.gt_u(aLo, aHi, bLo, bHi)), i32x4.gt_u(a, b))) return false;
  if (!checkV128(pair(i32x4_swar.ge_s(aLo, aHi, bLo, bHi)), i32x4.ge_s(a, b))) return false;
  if (!checkV128(pair(i32x4_swar.ge_u(aLo, aHi, bLo, bHi)), i32x4.ge_u(a, b))) return false;
  if (ASC_FEATURE_RELAXED_SIMD && !checkV128(pair(i32x4_swar.relaxed_laneselect(aLo, aHi, bLo, bHi, aLo, aHi)), i32x4.relaxed_laneselect(a, b, a))) return false;
  return true;
