...
fuzz("i16x4 scalar reference parity", (words: u32[]): bool => {
  ...
  if (
    !check32(i16x4.extract_lane_s(a, idx), i16x4_scalar.extract_lane_s(a, idx))
  )
    return false;
  if (
    !check32(i16x4.extract_lane_u(a, idx), i16x4_scalar.extract_lane_u(a, idx))
  )
    return false;
  if (
    !check64(
  ...
  if (!check64(i16x4.add_sat_s(a, b), i16x4_scalar.add_sat_s(a, b)))
    return false;
  if (!check64(i16x4.add_sat_u(a, b), i16x4_scalar.add_sat_u(a, b)))
    return false;
  if (!check64(i16x4.sub_sat_s(a, b), i16x4_scalar.sub_sat_s(a, b)))
    return false;
  if (!check64(i16x4.sub_sat_u(a, b), i16x4_scalar.sub_sat_u(a, b)))
    return false;
  if (!check64(i16x4.shl(a, shift), i16x4_scalar.shl(a, shift))) return false;
  if (!check64(i16x4.shr_s(a, shift), i16x4_scalar.shr_s(a, shift)))
    return false;
  if (!check64(i16x4.shr_u(a, shift), i16x4_scalar.shr_u(a, shift)))
    return false;
  ...
  if (!check64(i16x4.bitmask_lane(a), i16x4_scalar.bitmask_lane(a)))
    return false;
  ...
  if (!check64(i16x4.narrow_i32x2_s(c, d), i16x4_scalar.narrow_i32x2_s(c, d)))
    return false;
  if (!check64(i16x4.narrow_i32x2_u(c, d), i16x4_scalar.narrow_i32x2_u(c, d)))
    return false;
  if (!check64(i16x4.extend_low_i8x8_s(a), i16x4_scalar.extend_low_i8x8_s(a)))
    return false;
  if (!check64(i16x4.extend_low_i8x8_u(a), i16x4_scalar.extend_low_i8x8_u(a)))
    return false;
  if (!check64(i16x4.extend_high_i8x8_s(a), i16x4_scalar.extend_high_i8x8_s(a)))
    return false;
  if (!check64(i16x4.extend_high_i8x8_u(a), i16x4_scalar.extend_high_i8x8_u(a)))
    return false;
  if (
    !check64(
