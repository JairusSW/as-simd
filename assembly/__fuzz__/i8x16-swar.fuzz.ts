...
// @ts-expect-error: decorator
@inline function pair(lo: u64, hi: u64): v128 {
  return v128From64(lo, hi);
}
...
fuzz("i8x16_swar parity vs i8x16", (seedValue: i32): bool => {
  ...
  if (!checkV128(pair(lo, i8x16_swar.take_hi()), i8x16.splat(lane)))
    return false;
  if (
    !check32(
      i8x16_swar.extract_lane_s(aLo, aHi, idx),
      i8x16.extract_lane_s(a, 7),
    )
  )
    return false;
  if (
    !check32(
      i8x16_swar.extract_lane_u(aLo, aHi, idx),
      i8x16.extract_lane_u(a, 7),
    )
  )
    return false;
  lo = i8x16_swar.replace_lane(aLo, aHi, idx, lane);
  if (
    !checkV128(pair(lo, i8x16_swar.take_hi()), i8x16.replace_lane(a, 7, lane))
  )
    return false;
  ...
  if (!checkV128(pair(lo, i8x16_swar.take_hi()), i8x16.min_s(a, b)))
    return false;
  lo = i8x16_swar.min_u(aLo, aHi, bLo, bHi);
  if (!checkV128(pair(lo, i8x16_swar.take_hi()), i8x16.min_u(a, b)))
    return false;
  lo = i8x16_swar.max_s(aLo, aHi, bLo, bHi);
  if (!checkV128(pair(lo, i8x16_swar.take_hi()), i8x16.max_s(a, b)))
    return false;
  lo = i8x16_swar.max_u(aLo, aHi, bLo, bHi);
  if (!checkV128(pair(lo, i8x16_swar.take_hi()), i8x16.max_u(a, b)))
    return false;
  lo = i8x16_swar.avgr_u(aLo, aHi, bLo, bHi);
  if (!checkV128(pair(lo, i8x16_swar.take_hi()), i8x16.avgr_u(a, b)))
    return false;
  ...
  if (!checkV128(pair(lo, i8x16_swar.take_hi()), i8x16.add_sat_s(a, b)))
    return false;
  lo = i8x16_swar.add_sat_u(aLo, aHi, bLo, bHi);
  if (!checkV128(pair(lo, i8x16_swar.take_hi()), i8x16.add_sat_u(a, b)))
    return false;
  lo = i8x16_swar.sub_sat_s(aLo, aHi, bLo, bHi);
  if (!checkV128(pair(lo, i8x16_swar.take_hi()), i8x16.sub_sat_s(a, b)))
    return false;
  lo = i8x16_swar.sub_sat_u(aLo, aHi, bLo, bHi);
  if (!checkV128(pair(lo, i8x16_swar.take_hi()), i8x16.sub_sat_u(a, b)))
    return false;
  lo = i8x16_swar.shl(aLo, aHi, shift);
  if (!checkV128(pair(lo, i8x16_swar.take_hi()), i8x16.shl(a, shift)))
    return false;
  lo = i8x16_swar.shr_s(aLo, aHi, shift);
  if (!checkV128(pair(lo, i8x16_swar.take_hi()), i8x16.shr_s(a, shift)))
    return false;
  lo = i8x16_swar.shr_u(aLo, aHi, shift);
  if (!checkV128(pair(lo, i8x16_swar.take_hi()), i8x16.shr_u(a, shift)))
    return false;
  if (!checkBool(i8x16_swar.all_true(aLo, aHi), i8x16.all_true(a)))
    return false;
  ...
  if (!checkV128(pair(lo, i8x16_swar.take_hi()), i8x16.lt_s(a, b)))
    return false;
  lo = i8x16_swar.lt_u(aLo, aHi, bLo, bHi);
  if (!checkV128(pair(lo, i8x16_swar.take_hi()), i8x16.lt_u(a, b)))
    return false;
  lo = i8x16_swar.le_s(aLo, aHi, bLo, bHi);
  if (!checkV128(pair(lo, i8x16_swar.take_hi()), i8x16.le_s(a, b)))
    return false;
  lo = i8x16_swar.le_u(aLo, aHi, bLo, bHi);
  if (!checkV128(pair(lo, i8x16_swar.take_hi()), i8x16.le_u(a, b)))
    return false;
  lo = i8x16_swar.gt_s(aLo, aHi, bLo, bHi);
  if (!checkV128(pair(lo, i8x16_swar.take_hi()), i8x16.gt_s(a, b)))
    return false;
  lo = i8x16_swar.gt_u(aLo, aHi, bLo, bHi);
  if (!checkV128(pair(lo, i8x16_swar.take_hi()), i8x16.gt_u(a, b)))
    return false;
  lo = i8x16_swar.ge_s(aLo, aHi, bLo, bHi);
  if (!checkV128(pair(lo, i8x16_swar.take_hi()), i8x16.ge_s(a, b)))
    return false;
  lo = i8x16_swar.ge_u(aLo, aHi, bLo, bHi);
  if (!checkV128(pair(lo, i8x16_swar.take_hi()), i8x16.ge_u(a, b)))
    return false;
  return true;
