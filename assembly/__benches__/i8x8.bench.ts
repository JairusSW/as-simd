...
bench(
  ...
  () => {
    blackbox(
      i8x8.loadPartial(
        blackbox(i8x8_loadPartial_ptr),
        blackbox(i8x8_loadPartial_len),
        0,
        1,
        blackbox(i8x8_loadPartial_x),
      ),
    );
  },
  OPS,
...
bench(
  ...
  () => {
    i8x8.storePartial(
      blackbox(i8x8_storePartial_ptr),
      blackbox(i8x8_storePartial_a),
      blackbox(i8x8_storePartial_len),
    );
    blackbox(load<u64>(IO_PTR));
  },
  OPS,
...
bench(
  ...
  () => {
    blackbox(
      i8x8.extract_lane_s(
        blackbox(i8x8_extract_lane_s_a),
        blackbox(i8x8_extract_lane_s_lane),
      ),
    );
  },
  OPS,
...
bench(
  ...
  () => {
    blackbox(
      i8x8.extract_lane_u(
        blackbox(i8x8_extract_lane_u_a),
        blackbox(i8x8_extract_lane_u_lane),
      ),
    );
  },
  OPS,
...
bench(
  ...
  () => {
    blackbox(
      i8x8.replace_lane(
        blackbox(i8x8_replace_lane_a),
        blackbox(i8x8_replace_lane_lane),
        blackbox(i8x8_replace_lane_x),
      ),
    );
  },
  OPS,
...
bench(
  ...
  () => {
    blackbox(
      i8x8.add_sat_s(blackbox(i8x8_add_sat_s_a), blackbox(i8x8_add_sat_s_b)),
    );
  },
  OPS,
  8,
...
bench(
  ...
  () => {
    blackbox(
      i8x8.add_sat_u(blackbox(i8x8_add_sat_u_a), blackbox(i8x8_add_sat_u_b)),
    );
  },
  OPS,
  8,
...
bench(
  ...
  () => {
    blackbox(
      i8x8.sub_sat_s(blackbox(i8x8_sub_sat_s_a), blackbox(i8x8_sub_sat_s_b)),
    );
  },
  OPS,
  8,
...
bench(
  ...
  () => {
    blackbox(
      i8x8.sub_sat_u(blackbox(i8x8_sub_sat_u_a), blackbox(i8x8_sub_sat_u_b)),
    );
  },
  OPS,
  8,
...
bench(
  ...
  () => {
    blackbox(
      i8x8.narrow_i16x4_s(
        blackbox(i8x8_narrow_i16x4_s_a),
        blackbox(i8x8_narrow_i16x4_s_b),
      ),
    );
  },
  OPS,
...
bench(
  ...
  () => {
    blackbox(
      i8x8.narrow_i16x4_u(
        blackbox(i8x8_narrow_i16x4_u_a),
        blackbox(i8x8_narrow_i16x4_u_b),
      ),
    );
  },
  OPS,
...
if (ASC_FEATURE_RELAXED_SIMD) {
  bench(
    ...
    () => {
      blackbox(
        i8x8.relaxed_swizzle(
          blackbox(i8x8_relaxed_swizzle_a),
          blackbox(i8x8_relaxed_swizzle_b),
        ),
      );
    },
    OPS,
  ...
  bench(
    ...
    () => {
      blackbox(
        i8x8.relaxed_laneselect(
          blackbox(i8x8_relaxed_laneselect_a),
          blackbox(i8x8_relaxed_laneselect_b),
          blackbox(i8x8_relaxed_laneselect_m),
        ),
      );
    },
    OPS,
