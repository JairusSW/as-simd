...
bench("i16x4.ctor", () => {
  blackbox(i16x4(blackbox(BENCH_I16), blackbox(BENCH_I16), blackbox(BENCH_I16), blackbox(BENCH_I16)));
}, OPS, 8);
...
bench("i16x4.loadPartial", () => {
  blackbox(i16x4.loadPartial(blackbox(BENCH_PTR), blackbox(BENCH_LEN), 0, 2, blackbox(BENCH_I16)));
}, OPS, 8);
dumpToFile("i16x4", "load-partial");

bench("i16x4.storePartial", () => {
  i16x4.storePartial(blackbox(BENCH_PTR), blackbox(BENCH_A), blackbox(BENCH_LEN), 0, 2);
  blackbox(load<u64>(IO_PTR));
}, OPS, 8);
...
bench("i16x4.replace_lane", () => {
  blackbox(i16x4.replace_lane(blackbox(BENCH_A), blackbox(BENCH_LANE4), blackbox(BENCH_I16)));
}, OPS, 8);
...
bench("i16x4.shuffle", () => {
  blackbox(i16x4.shuffle(blackbox(BENCH_A), blackbox(BENCH_B), blackbox(BENCH_LANE8), blackbox(BENCH_LANE8), blackbox(BENCH_LANE8), blackbox(BENCH_LANE8)));
}, OPS, 8);
dumpToFile("i16x4", "shuffle");

if (ASC_FEATURE_RELAXED_SIMD) {
  bench("i16x4.relaxed_laneselect", () => {
    blackbox(i16x4.relaxed_laneselect(blackbox(BENCH_A), blackbox(BENCH_B), blackbox(BENCH_M)));
  }, OPS, 24);
  ...
  bench("i16x4.relaxed_dot_i8x8_i7x8_s", () => {
    blackbox(i16x4.relaxed_dot_i8x8_i7x8_s(blackbox(BENCH_A), blackbox(BENCH_B)));
  }, OPS, 8);
