...
bench("i64x2.splat", () => sinkPair(i64x2_swar.splat(blackbox(X))), OPS, 8);
dumpToFile("i64x2", "splat");
bench(
  "i64x2.extract_lane",
  () => blackbox(i64x2_swar.extract_lane(blackbox(A_LO), blackbox(A_HI), 1)),
  OPS,
  8,
);
...
bench(
  ...
  () =>
    sinkPair(
      i64x2_swar.replace_lane(blackbox(A_LO), blackbox(A_HI), 1, blackbox(X)),
    ),
  OPS,
  8,
);
...
bench(
  "i64x2.abs",
  () => sinkPair(i64x2_swar.abs(blackbox(A_LO), blackbox(A_HI))),
  OPS,
  8,
);
...
bench(
  "i64x2.neg",
  () => sinkPair(i64x2_swar.neg(blackbox(A_LO), blackbox(A_HI))),
  OPS,
  8,
);
...
bench(
  "i64x2.shl",
  () =>
    sinkPair(i64x2_swar.shl(blackbox(A_LO), blackbox(A_HI), blackbox(SHIFT))),
  OPS,
  8,
);
...
bench(
  "i64x2.shr_s",
  () =>
    sinkPair(i64x2_swar.shr_s(blackbox(A_LO), blackbox(A_HI), blackbox(SHIFT))),
  OPS,
  8,
);
...
bench(
  "i64x2.shr_u",
  () =>
    sinkPair(i64x2_swar.shr_u(blackbox(A_LO), blackbox(A_HI), blackbox(SHIFT))),
  OPS,
  8,
);
...
bench(
  "i64x2.all_true",
  () => blackbox(i64x2_swar.all_true(blackbox(A_LO), blackbox(A_HI))),
  OPS,
  8,
);
...
bench(
  "i64x2.bitmask",
  () => blackbox(i64x2_swar.bitmask(blackbox(A_LO), blackbox(A_HI))),
  OPS,
  8,
);
...
bench(
  ...
  () => sinkPair(i64x2_swar.extend_low_i32x4_s(blackbox(A_LO), blackbox(A_HI))),
  OPS,
  8,
);
...
bench(
  ...
  () => sinkPair(i64x2_swar.extend_low_i32x4_u(blackbox(A_LO), blackbox(A_HI))),
  OPS,
  8,
);
...
bench(
  ...
  () =>
    sinkPair(i64x2_swar.extend_high_i32x4_s(blackbox(A_LO), blackbox(A_HI))),
  OPS,
  8,
);
...
bench(
  ...
  () =>
    sinkPair(i64x2_swar.extend_high_i32x4_u(blackbox(A_LO), blackbox(A_HI))),
  OPS,
  8,
);
