...
@inline function add_new_const(a: u64, b: u64): u64 {
  return (
    ((a & 0x7f7f7f7f7f7f7f7f) + (b & 0x7f7f7f7f7f7f7f7f)) ^
    ((a ^ b) & 0x8080808080808080)
  );
}
...
if (
  add_new(0xfedcba9876543210, 0x7766554433221100) !=
    add_new_const(0xfedcba9876543210, 0x7766554433221100) ||
  add_new(0xfedcba9876543210, 0x7766554433221100) !=
    add_new_v64(0xfedcba9876543210, 0x7766554433221100) ||
  add_new(0xfedcba9876543210, 0x7766554433221100) !=
    add_new_locals(0xfedcba9876543210, 0x7766554433221100) ||
  add_new(0xfedcba9876543210, 0x7766554433221100) !=
    add_new_v64_locals(0xfedcba9876543210, 0x7766554433221100) ||
  add_new(0xfedcba9876543210, 0x7766554433221100) !=
    add_split32(0xfedcba9876543210, 0x7766554433221100) ||
  add_new(0xfedcba9876543210, 0x7766554433221100) !=
    add_split16(0xfedcba9876543210, 0x7766554433221100) ||
  add_new(0xfedcba9876543210, 0x7766554433221100) !=
    add_nibble(0xfedcba9876543210, 0x7766554433221100) ||
  add_new(0xfedcba9876543210, 0x7766554433221100) !=
    add_nibble_xor(0xfedcba9876543210, 0x7766554433221100) ||
  add_new(0xffffffffffffffff, 0x0101010101010101) !=
    add_new_const(0xffffffffffffffff, 0x0101010101010101) ||
  add_new(0xffffffffffffffff, 0x0101010101010101) !=
    add_new_v64(0xffffffffffffffff, 0x0101010101010101) ||
  add_new(0xffffffffffffffff, 0x0101010101010101) !=
    add_new_locals(0xffffffffffffffff, 0x0101010101010101) ||
  add_new(0xffffffffffffffff, 0x0101010101010101) !=
    add_new_v64_locals(0xffffffffffffffff, 0x0101010101010101) ||
  add_new(0xffffffffffffffff, 0x0101010101010101) !=
    add_split32(0xffffffffffffffff, 0x0101010101010101) ||
  add_new(0xffffffffffffffff, 0x0101010101010101) !=
    add_split16(0xffffffffffffffff, 0x0101010101010101) ||
  add_new(0xffffffffffffffff, 0x0101010101010101) !=
    add_nibble(0xffffffffffffffff, 0x0101010101010101) ||
  add_new(0xffffffffffffffff, 0x0101010101010101) !=
    add_nibble_xor(0xffffffffffffffff, 0x0101010101010101)
) {
  unreachable();
}
