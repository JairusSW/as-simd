...
dumpToFile("i32x2-signed-cmp-comp", "lt-lib");
bench(
  "i32x2-lt-s.via-ge",
  () => {
...
dumpToFile("i32x2-signed-cmp-comp", "lt-via-ge");
bench(
  "i32x2-lt-s.old",
  () => {
...
dumpToFile("i32x2-signed-cmp-comp", "lt-old");
bench(
  "i32x2-le-s.lib",
  () => {
...
dumpToFile("i32x2-signed-cmp-comp", "le-lib");
bench(
  "i32x2-le-s.via-ge",
  () => {
...
dumpToFile("i32x2-signed-cmp-comp", "le-via-ge");
bench(
  "i32x2-le-s.old",
  () => {
...
dumpToFile("i32x2-signed-cmp-comp", "le-old");
bench(
  "i32x2-gt-s.lib",
  () => {
...
dumpToFile("i32x2-signed-cmp-comp", "gt-lib");
bench(
  "i32x2-gt-s.via-le",
  () => {
...
dumpToFile("i32x2-signed-cmp-comp", "gt-via-le");
bench(
  "i32x2-gt-s.via-lt",
  () => {
...
dumpToFile("i32x2-signed-cmp-comp", "gt-via-lt");
bench(
  "i32x2-gt-s.old",
  () => {
...
dumpToFile("i32x2-signed-cmp-comp", "gt-old");
bench(
  "i32x2-ge-s.lib",
  () => {
...
dumpToFile("i32x2-signed-cmp-comp", "ge-lib");
bench(
  "i32x2-ge-s.via-lt",
  () => {
...
dumpToFile("i32x2-signed-cmp-comp", "ge-via-lt");
bench(
  "i32x2-ge-s.old",
  () => {
...
dumpToFile("i32x2-signed-cmp-comp", "ge-old");
