...
@inline function ne_nonzero_expand_split(a: u64, b: u64): u64 {
  ...
  return (
    (((loMask >> 7) * 0xff) as u64) | ((((hiMask >> 7) * 0xff) as u64) << 32)
  );
}

if (
  ne_current(0xfedcba9876543210, 0x7766554433221100) !=
    ne_nonzero_expand(0xfedcba9876543210, 0x7766554433221100) ||
  ne_current(0xfedcba9876543210, 0x7766554433221100) !=
    ne_nonzero_expand_split(0xfedcba9876543210, 0x7766554433221100) ||
  ne_current(0, 0) != ne_nonzero_expand(0, 0) ||
  ne_current(0, 0) != ne_nonzero_expand_split(0, 0) ||
  ne_current(0x0100000000000000, 0) !=
    ne_nonzero_expand(0x0100000000000000, 0) ||
  ne_current(0x0100000000000000, 0) !=
    ne_nonzero_expand_split(0x0100000000000000, 0)
) {
  unreachable();
}
