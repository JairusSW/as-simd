...
@inline function le_s_old(aLo: u64, aHi: u64, bLo: u64, bHi: u64): u64 {
  ...
  return set_pair(
    lo,
    ~(((((~bx & ax) | (~(bx ^ ax) & d)) & 0x8080808080808080) >> 7) * 0xff),
  );
}
// @ts-expect-error: decorator
...
@inline function lt_u_old(aLo: u64, aHi: u64, bLo: u64, bHi: u64): u64 {
  ...
  const lo =
    ((((~aLo & bLo) | (~(aLo ^ bLo) & d)) & 0x8080808080808080) >> 7) * 0xff;
  d =
    ((aHi | 0x8080808080808080) - (bHi & 0x7f7f7f7f7f7f7f7f)) ^
    ((aHi ^ ~bHi) & 0x8080808080808080);
  return set_pair(
    lo,
    ((((~aHi & bHi) | (~(aHi ^ bHi) & d)) & 0x8080808080808080) >> 7) * 0xff,
  );
}
// @ts-expect-error: decorator
@inline function le_u_old(aLo: u64, aHi: u64, bLo: u64, bHi: u64): u64 {
  ...
  const lo = ~(
    ((((~bLo & aLo) | (~(bLo ^ aLo) & d)) & 0x8080808080808080) >> 7) *
    0xff
  );
  d =
  ...
  return set_pair(
    lo,
    ~(((((~bHi & aHi) | (~(bHi ^ aHi) & d)) & 0x8080808080808080) >> 7) * 0xff),
  );
}
// @ts-expect-error: decorator
@inline function gt_u_old(aLo: u64, aHi: u64, bLo: u64, bHi: u64): u64 {
  let d =
    ...
    ((bLo ^ ~aLo) & 0x8080808080808080);
  const lo =
    ((((~bLo & aLo) | (~(bLo ^ aLo) & d)) & 0x8080808080808080) >> 7) * 0xff;
  d =
    ((bHi | 0x8080808080808080) - (aHi & 0x7f7f7f7f7f7f7f7f)) ^
    ((bHi ^ ~aHi) & 0x8080808080808080);
  return set_pair(
...
@inline function ge_u_old(aLo: u64, aHi: u64, bLo: u64, bHi: u64): u64 {
  let d =
    ...
    ((aLo ^ ~bLo) & 0x8080808080808080);
  const lo = ~(
    ((((~aLo & bLo) | (~(aLo ^ bLo) & d)) & 0x8080808080808080) >> 7) *
    0xff
  );
  d =
    ((aHi | 0x8080808080808080) - (bHi & 0x7f7f7f7f7f7f7f7f)) ^
...
bench(
  ...
  () => {
    blackbox(
      lt_s_lib(blackbox(aLo), blackbox(aHi), blackbox(bLo), blackbox(bHi)),
    );
    blackbox(hi_sink);
  },
  OPS,
...
dumpToFile("i8x16-cmp-comp", "lt-s-lib");
bench(
  "i8x16.lt-s.old",
  () => {
    blackbox(
      lt_s_old(blackbox(aLo), blackbox(aHi), blackbox(bLo), blackbox(bHi)),
    );
    blackbox(hi_sink);
  },
  OPS,
...
dumpToFile("i8x16-cmp-comp", "lt-s-old");
bench(
  "i8x16.lt-s.via-ge",
  () => {
    blackbox(
      lt_s_via_ge(blackbox(aLo), blackbox(aHi), blackbox(bLo), blackbox(bHi)),
    );
    blackbox(hi_sink);
  },
  OPS,
...
dumpToFile("i8x16-cmp-comp", "lt-s-via-ge");

bench(
  "i8x16.le-s.lib",
  () => {
    blackbox(
      le_s_lib(blackbox(aLo), blackbox(aHi), blackbox(bLo), blackbox(bHi)),
    );
    blackbox(hi_sink);
  },
  OPS,
...
dumpToFile("i8x16-cmp-comp", "le-s-lib");
bench(
  "i8x16.le-s.old",
  () => {
    blackbox(
      le_s_old(blackbox(aLo), blackbox(aHi), blackbox(bLo), blackbox(bHi)),
    );
    blackbox(hi_sink);
  },
  OPS,
...
dumpToFile("i8x16-cmp-comp", "le-s-old");
bench(
  "i8x16.le-s.via-ge",
  () => {
    blackbox(
      le_s_via_ge(blackbox(aLo), blackbox(aHi), blackbox(bLo), blackbox(bHi)),
    );
    blackbox(hi_sink);
  },
  OPS,
...
dumpToFile("i8x16-cmp-comp", "le-s-via-ge");

bench(
  "i8x16.gt-s.lib",
  () => {
    blackbox(
      gt_s_lib(blackbox(aLo), blackbox(aHi), blackbox(bLo), blackbox(bHi)),
    );
    blackbox(hi_sink);
  },
  OPS,
...
dumpToFile("i8x16-cmp-comp", "gt-s-lib");
bench(
  "i8x16.gt-s.old",
  () => {
    blackbox(
      gt_s_old(blackbox(aLo), blackbox(aHi), blackbox(bLo), blackbox(bHi)),
    );
    blackbox(hi_sink);
  },
  OPS,
...
dumpToFile("i8x16-cmp-comp", "gt-s-old");
bench(
  "i8x16.gt-s.via-lt",
  () => {
    blackbox(
      gt_s_via_lt(blackbox(aLo), blackbox(aHi), blackbox(bLo), blackbox(bHi)),
    );
    blackbox(hi_sink);
  },
  OPS,
...
dumpToFile("i8x16-cmp-comp", "gt-s-via-lt");

bench(
  "i8x16.ge-s.lib",
  () => {
    blackbox(
      ge_s_lib(blackbox(aLo), blackbox(aHi), blackbox(bLo), blackbox(bHi)),
    );
    blackbox(hi_sink);
  },
  OPS,
...
dumpToFile("i8x16-cmp-comp", "ge-s-lib");
bench(
  "i8x16.ge-s.old",
  () => {
    blackbox(
      ge_s_old(blackbox(aLo), blackbox(aHi), blackbox(bLo), blackbox(bHi)),
    );
    blackbox(hi_sink);
  },
  OPS,
...
dumpToFile("i8x16-cmp-comp", "ge-s-old");
bench(
  "i8x16.ge-s.via-lt",
  () => {
    blackbox(
      ge_s_via_lt(blackbox(aLo), blackbox(aHi), blackbox(bLo), blackbox(bHi)),
    );
    blackbox(hi_sink);
  },
  OPS,
...
dumpToFile("i8x16-cmp-comp", "ge-s-via-lt");

bench(
  "i8x16.lt-u.lib",
  () => {
    blackbox(
      lt_u_lib(blackbox(aLo), blackbox(aHi), blackbox(bLo), blackbox(bHi)),
    );
    blackbox(hi_sink);
  },
  OPS,
...
dumpToFile("i8x16-cmp-comp", "lt-u-lib");
bench(
  "i8x16.lt-u.old",
  () => {
    blackbox(
      lt_u_old(blackbox(aLo), blackbox(aHi), blackbox(bLo), blackbox(bHi)),
    );
    blackbox(hi_sink);
  },
  OPS,
...
dumpToFile("i8x16-cmp-comp", "lt-u-old");

bench(
  "i8x16.le-u.lib",
  () => {
    blackbox(
      le_u_lib(blackbox(aLo), blackbox(aHi), blackbox(bLo), blackbox(bHi)),
    );
    blackbox(hi_sink);
  },
  OPS,
...
dumpToFile("i8x16-cmp-comp", "le-u-lib");
bench(
  "i8x16.le-u.old",
  () => {
    blackbox(
      le_u_old(blackbox(aLo), blackbox(aHi), blackbox(bLo), blackbox(bHi)),
    );
    blackbox(hi_sink);
  },
  OPS,
...
dumpToFile("i8x16-cmp-comp", "le-u-old");

bench(
  "i8x16.gt-u.lib",
  () => {
    blackbox(
      gt_u_lib(blackbox(aLo), blackbox(aHi), blackbox(bLo), blackbox(bHi)),
    );
    blackbox(hi_sink);
  },
  OPS,
...
dumpToFile("i8x16-cmp-comp", "gt-u-lib");
bench(
  "i8x16.gt-u.old",
  () => {
    blackbox(
      gt_u_old(blackbox(aLo), blackbox(aHi), blackbox(bLo), blackbox(bHi)),
    );
    blackbox(hi_sink);
  },
  OPS,
...
dumpToFile("i8x16-cmp-comp", "gt-u-old");

bench(
  "i8x16.ge-u.lib",
  () => {
    blackbox(
      ge_u_lib(blackbox(aLo), blackbox(aHi), blackbox(bLo), blackbox(bHi)),
    );
    blackbox(hi_sink);
  },
  OPS,
...
dumpToFile("i8x16-cmp-comp", "ge-u-lib");
bench(
  "i8x16.ge-u.old",
  () => {
    blackbox(
      ge_u_old(blackbox(aLo), blackbox(aHi), blackbox(bLo), blackbox(bHi)),
    );
    blackbox(hi_sink);
  },
  OPS,
...
dumpToFile("i8x16-cmp-comp", "ge-u-old");
