...
@inline function bitmask_split_mul_shifted(a: u64): i32 {
  const lo = (((((a >> 7) & 0x0000000001010101) * 0x01020408) >> 24) &
    0x0f) as i32;
  const hi = (((((a >> 39) & 0x0000000001010101) * 0x01020408) >> 20) &
    0xf0) as i32;
  return lo | hi;
}

if (
  bitmask_current(0xfedcba9876543210) !=
    bitmask_mul_direct(0xfedcba9876543210) ||
  bitmask_current(0xfedcba9876543210) !=
    bitmask_mul_shifted(0xfedcba9876543210) ||
  bitmask_current(0xfedcba9876543210) !=
    bitmask_manual_shifts(0xfedcba9876543210) ||
  bitmask_current(0xfedcba9876543210) !=
    bitmask_manual_lowsplit(0xfedcba9876543210) ||
  bitmask_current(0xfedcba9876543210) !=
    bitmask_split_mul(0xfedcba9876543210) ||
  bitmask_current(0xfedcba9876543210) !=
    bitmask_split_mul_shifted(0xfedcba9876543210)
) {
  unreachable();
}
