...
// @ts-expect-error: decorator
@inline function swizzle_via_relaxed(
  aLo: u64,
  aHi: u64,
  sLo: u64,
  sHi: u64,
...
bench(
  ...
  () => {
    blackbox(
      swizzle_lib(blackbox(aLo), blackbox(aHi), blackbox(sLo), blackbox(sHi)),
    );
    blackbox(hi_sink);
  },
  OPS,
...
bench(
  ...
  () => {
    blackbox(
      swizzle_if(blackbox(aLo), blackbox(aHi), blackbox(sLo), blackbox(sHi)),
    );
    blackbox(hi_sink);
  },
  OPS,
...
bench(
  "i8x16.relaxed-swizzle.lib",
  () => {
    blackbox(
      relaxed_lib(blackbox(aLo), blackbox(aHi), blackbox(sLo), blackbox(sHi)),
    );
    blackbox(hi_sink);
  },
  OPS,
...
bench(
  "i8x16.relaxed-swizzle.if",
  () => {
    blackbox(
      relaxed_if(blackbox(aLo), blackbox(aHi), blackbox(sLo), blackbox(sHi)),
    );
    blackbox(hi_sink);
  },
  OPS,
