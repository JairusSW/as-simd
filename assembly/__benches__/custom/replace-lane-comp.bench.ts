...
bench("replace-lane.lib", () => { blackbox(i8x8.replace_lane(blackbox(a), blackbox(lane), blackbox(value))); }, OPS, 8); dumpToFile("replace-lane-comp", "lib");
bench("replace-lane.current", () => { blackbox(replace_current(blackbox(a), blackbox(lane), blackbox(value))); }, OPS, 8); dumpToFile("replace-lane-comp", "current");
bench("replace-lane.switch", () => { blackbox(replace_switch(blackbox(a), blackbox(lane), blackbox(value))); }, OPS, 8); dumpToFile("replace-lane-comp", "switch");
