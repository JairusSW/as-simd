...
@inline function next64(): u64 {
  return bench_common.next64();
}
// @ts-expect-error: decorator
@inline function next128(): u64 {
  return bench_common.next128();
}
// @ts-expect-error: decorator
@inline function next128Hi(): u64 {
  return bench_common.next128Hi();
}
...
// @ts-expect-error: decorator
@inline function shuffle_select(
  a: u64,
  b: u64,
  l0: u8,
  l1: u8,
  ...
  const i0 = l0 & 7,
    ...
    i6 = l6 & 7,
    i7 = l7 & 7;
  const a0 = byte_at(a, i0),
    a1 = byte_at(a, i1),
    a2 = byte_at(a, i2),
    a3 = byte_at(a, i3);
  const a4 = byte_at(a, i4),
    a5 = byte_at(a, i5),
    a6 = byte_at(a, i6),
    a7 = byte_at(a, i7);
  const b0 = byte_at(b, i0),
    b1 = byte_at(b, i1),
    b2 = byte_at(b, i2),
    b3 = byte_at(b, i3);
  const b4 = byte_at(b, i4),
    b5 = byte_at(b, i5),
    b6 = byte_at(b, i6),
    b7 = byte_at(b, i7);
  return pack8(
...
// @ts-expect-error: decorator
@inline function shuffle_inline(
  a: u64,
  b: u64,
  l0: u8,
  l1: u8,
  ...
  const a0 = (a >> (i0 << 3)) & 0xff,
    a1 = (a >> (i1 << 3)) & 0xff,
    a2 = (a >> (i2 << 3)) & 0xff,
    a3 = (a >> (i3 << 3)) & 0xff;
  const a4 = (a >> (i4 << 3)) & 0xff,
    a5 = (a >> (i5 << 3)) & 0xff,
    a6 = (a >> (i6 << 3)) & 0xff,
    a7 = (a >> (i7 << 3)) & 0xff;
  const b0 = (b >> (i0 << 3)) & 0xff,
    b1 = (b >> (i1 << 3)) & 0xff,
    b2 = (b >> (i2 << 3)) & 0xff,
    b3 = (b >> (i3 << 3)) & 0xff;
  const b4 = (b >> (i4 << 3)) & 0xff,
    b5 = (b >> (i5 << 3)) & 0xff,
    b6 = (b >> (i6 << 3)) & 0xff,
    b7 = (b >> (i7 << 3)) & 0xff;
...
// @ts-expect-error: decorator
@inline function shuffle_ternary(
  a: u64,
  b: u64,
  l0: u8,
  l1: u8,
...
// @ts-expect-error: decorator
@inline function shuffle_select_flags(
  a: u64,
  b: u64,
  l0: u8,
  l1: u8,
...
// @ts-expect-error: decorator
@inline function shuffle_inline_noidx(
  a: u64,
  b: u64,
  l0: u8,
  l1: u8,
  ...
  const a0 = (a >> (((l0 as u64) & 7) << 3)) & 0xff,
    a1 = (a >> (((l1 as u64) & 7) << 3)) & 0xff;
  const a2 = (a >> (((l2 as u64) & 7) << 3)) & 0xff,
    a3 = (a >> (((l3 as u64) & 7) << 3)) & 0xff;
  const a4 = (a >> (((l4 as u64) & 7) << 3)) & 0xff,
    a5 = (a >> (((l5 as u64) & 7) << 3)) & 0xff;
  const a6 = (a >> (((l6 as u64) & 7) << 3)) & 0xff,
    a7 = (a >> (((l7 as u64) & 7) << 3)) & 0xff;

  const b0 = (b >> (((l0 as u64) & 7) << 3)) & 0xff,
    b1 = (b >> (((l1 as u64) & 7) << 3)) & 0xff;
  const b2 = (b >> (((l2 as u64) & 7) << 3)) & 0xff,
    b3 = (b >> (((l3 as u64) & 7) << 3)) & 0xff;
  const b4 = (b >> (((l4 as u64) & 7) << 3)) & 0xff,
    b5 = (b >> (((l5 as u64) & 7) << 3)) & 0xff;
  const b6 = (b >> (((l6 as u64) & 7) << 3)) & 0xff,
    b7 = (b >> (((l7 as u64) & 7) << 3)) & 0xff;
...
// @ts-expect-error: decorator
@inline function shuffle_inline_shifts(
  a: u64,
  b: u64,
  l0: u8,
  l1: u8,
  ...
  const s0 = ((l0 as u64) << 3) & 56,
    s1 = ((l1 as u64) << 3) & 56,
    s2 = ((l2 as u64) << 3) & 56,
    s3 = ((l3 as u64) << 3) & 56;
  const s4 = ((l4 as u64) << 3) & 56,
    s5 = ((l5 as u64) << 3) & 56,
    s6 = ((l6 as u64) << 3) & 56,
    s7 = ((l7 as u64) << 3) & 56;
...
// @ts-expect-error: decorator
@inline function shuffle_select_src(
  a: u64,
  b: u64,
  l0: u8,
  l1: u8,
  ...
  const i4 = (l4 & 7) as u64,
    ...
    i6 = (l6 & 7) as u64,
    i7 = (l7 & 7) as u64;
  const s0 = select<u64>(a, b, l0 < 8),
    s1 = select<u64>(a, b, l1 < 8),
    s2 = select<u64>(a, b, l2 < 8),
    s3 = select<u64>(a, b, l3 < 8);
  const s4 = select<u64>(a, b, l4 < 8),
    s5 = select<u64>(a, b, l5 < 8),
    s6 = select<u64>(a, b, l6 < 8),
    s7 = select<u64>(a, b, l7 < 8);
  return pack8(
    (s0 >> (i0 << 3)) & 0xff,
    (s1 >> (i1 << 3)) & 0xff,
    (s2 >> (i2 << 3)) & 0xff,
...
@inline function shuffle_mask(
  ...
  const i0 = l0 & 7,
    ...
    i6 = l6 & 7,
    i7 = l7 & 7;
  const m0 = ge8_mask_byte(l0),
    m1 = ge8_mask_byte(l1),
    m2 = ge8_mask_byte(l2),
    m3 = ge8_mask_byte(l3);
  const m4 = ge8_mask_byte(l4),
    m5 = ge8_mask_byte(l5),
    m6 = ge8_mask_byte(l6),
    m7 = ge8_mask_byte(l7);
...
@inline function shuffle_batch(
  ...
  const i0 = (idx & 0xff) as u64,
    i1 = ((idx >> 8) & 0xff) as u64,
    i2 = ((idx >> 16) & 0xff) as u64,
    i3 = ((idx >> 24) & 0xff) as u64;
  const i4 = ((idx >> 32) & 0xff) as u64,
    i5 = ((idx >> 40) & 0xff) as u64,
    i6 = ((idx >> 48) & 0xff) as u64,
    i7 = ((idx >> 56) & 0xff) as u64;
...
// @ts-expect-error: decorator
@inline function shuffle_swar_only(
  a: u64,
  b: u64,
  l0: u8,
  l1: u8,
...
// @ts-expect-error: decorator
@inline function shuffle_swar_lib(
  a: u64,
  b: u64,
  l0: u8,
  l1: u8,
...
// @ts-expect-error: decorator
@inline function shuffle_swizzle_blend(
  a: u64,
  b: u64,
  l0: u8,
  l1: u8,
  ...
  const mask = pack8(
    select<u64>(0, 0x80, l0 < 8),
    select<u64>(0, 0x80, l1 < 8),
    select<u64>(0, 0x80, l2 < 8),
    select<u64>(0, 0x80, l3 < 8),
    select<u64>(0, 0x80, l4 < 8),
    select<u64>(0, 0x80, l5 < 8),
    select<u64>(0, 0x80, l6 < 8),
    select<u64>(0, 0x80, l7 < 8),
  );
...
bench(
  "shuffle.select-flags",
  () => {
    blackbox(
      shuffle_select_flags(
        nextA(),
        nextB(),
        nextLane16(),
        nextLane16(),
...
bench(
  "shuffle.inline-noidx",
  () => {
    blackbox(
      shuffle_inline_noidx(
        nextA(),
        nextB(),
        nextLane16(),
        nextLane16(),
...
bench(
  "shuffle.inline-shifts",
  () => {
    blackbox(
      shuffle_inline_shifts(
        nextA(),
        nextB(),
        nextLane16(),
        nextLane16(),
...
bench(
  "shuffle.swizzle-blend",
  () => {
    blackbox(
      shuffle_swizzle_blend(
        nextA(),
        nextB(),
        nextLane16(),
        nextLane16(),
