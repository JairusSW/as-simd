...
@inline function lt_s_old(a: u64, b: u64): u64 {
  ...
  const dlo =
    ((ax | 0x0000800000008000) - (bx & 0x00007fff00007fff)) ^
    ((ax ^ ~bx) & 0x0000800000008000);
  const dhi =
    ((ax | 0x8000000080000000) - (bx & 0x7fff00007fff0000)) ^
    ((ax ^ ~bx) & 0x8000000080000000);
  const ml = (((~ax & bx) | (~(ax ^ bx) & dlo)) & 0x0000800000008000) >> 15;
  const mh = (((~ax & bx) | (~(ax ^ bx) & dhi)) & 0x8000000080000000) >> 15;
  return (
    ((ml * 0xffff) & 0x0000ffff0000ffff) | ((mh * 0xffff) & 0xffff0000ffff0000)
  );
}
// @ts-expect-error: decorator
@inline function le_s_lib(a: u64, b: u64): u64 {
  return i16x4.le_s(a, b);
}
// @ts-expect-error: decorator
@inline function le_s_via_ge(a: u64, b: u64): u64 {
  return i16x4.ge_s(b, a);
}
// @ts-expect-error: decorator
@inline function gt_s_lib(a: u64, b: u64): u64 {
  return i16x4.gt_s(a, b);
}
// @ts-expect-error: decorator
...
dumpToFile("i16x4-signed-cmp-comp", "lt-lib");
bench(
  "i16x4-lt-s.via-ge",
  () => {
...
dumpToFile("i16x4-signed-cmp-comp", "lt-via-ge");
bench(
  "i16x4-lt-s.old",
  () => {
...
dumpToFile("i16x4-signed-cmp-comp", "lt-old");
bench(
  "i16x4-le-s.lib",
  () => {
...
dumpToFile("i16x4-signed-cmp-comp", "le-lib");
bench(
  "i16x4-le-s.via-ge",
  () => {
...
dumpToFile("i16x4-signed-cmp-comp", "le-via-ge");
bench(
  "i16x4-gt-s.lib",
  () => {
...
dumpToFile("i16x4-signed-cmp-comp", "gt-lib");
bench(
  "i16x4-gt-s.via-le",
  () => {
...
dumpToFile("i16x4-signed-cmp-comp", "gt-via-le");
bench(
  "i16x4-ge-s.lib",
  () => {
...
dumpToFile("i16x4-signed-cmp-comp", "ge-lib");
bench(
  "i16x4-ge-s.via-lt",
  () => {
...
dumpToFile("i16x4-signed-cmp-comp", "ge-via-lt");
