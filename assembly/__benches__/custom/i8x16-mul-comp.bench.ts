...
@inline function mul_pairs(aLo: u64, aHi: u64, bLo: u64, bHi: u64): u64 {
  const lo0 =
    ...
    (((((aLo >> 8) & 0xff) * ((bLo >> 8) & 0xff)) & 0xff) << 8);
  const lo1 =
    (((((aLo >> 16) & 0xff) * ((bLo >> 16) & 0xff)) & 0xff) |
      (((((aLo >> 24) & 0xff) * ((bLo >> 24) & 0xff)) & 0xff) << 8)) <<
    16;
  const lo2 =
    (((((aLo >> 32) & 0xff) * ((bLo >> 32) & 0xff)) & 0xff) |
      (((((aLo >> 40) & 0xff) * ((bLo >> 40) & 0xff)) & 0xff) << 8)) <<
    32;
  const lo3 =
    (((((aLo >> 48) & 0xff) * ((bLo >> 48) & 0xff)) & 0xff) |
      (((((aLo >> 56) & 0xff) * ((bLo >> 56) & 0xff)) & 0xff) << 8)) <<
    48;
  const hi0 =
    (((aHi & 0xff) * (bHi & 0xff)) & 0xff) |
    (((((aHi >> 8) & 0xff) * ((bHi >> 8) & 0xff)) & 0xff) << 8);
  const hi1 =
    (((((aHi >> 16) & 0xff) * ((bHi >> 16) & 0xff)) & 0xff) |
      (((((aHi >> 24) & 0xff) * ((bHi >> 24) & 0xff)) & 0xff) << 8)) <<
    16;
  const hi2 =
    (((((aHi >> 32) & 0xff) * ((bHi >> 32) & 0xff)) & 0xff) |
      (((((aHi >> 40) & 0xff) * ((bHi >> 40) & 0xff)) & 0xff) << 8)) <<
    32;
  const hi3 =
    (((((aHi >> 48) & 0xff) * ((bHi >> 48) & 0xff)) & 0xff) |
      (((((aHi >> 56) & 0xff) * ((bHi >> 56) & 0xff)) & 0xff) << 8)) <<
    48;
...
@inline function mul_extmul(aLo: u64, aHi: u64, bLo: u64, bHi: u64): u64 {
  ...
  return set_pair(
    pack_low_bytes(lo16Lo, lo16Hi),
    pack_low_bytes(hi16Lo, hi16Hi),
  );
}
...
bench(
  ...
  () => {
    blackbox(
      mul_lib(blackbox(aLo), blackbox(aHi), blackbox(bLo), blackbox(bHi)),
    );
    blackbox(hi_sink);
  },
  OPS,
...
bench(
  ...
  () => {
    blackbox(
      mul_expand(blackbox(aLo), blackbox(aHi), blackbox(bLo), blackbox(bHi)),
    );
    blackbox(hi_sink);
  },
  OPS,
...
bench(
  ...
  () => {
    blackbox(
      mul_pairs(blackbox(aLo), blackbox(aHi), blackbox(bLo), blackbox(bHi)),
    );
    blackbox(hi_sink);
  },
  OPS,
...
bench(
  ...
  () => {
    blackbox(
      mul_split32(blackbox(aLo), blackbox(aHi), blackbox(bLo), blackbox(bHi)),
    );
    blackbox(hi_sink);
  },
  OPS,
...
bench(
  ...
  () => {
    blackbox(
      mul_extmul(blackbox(aLo), blackbox(aHi), blackbox(bLo), blackbox(bHi)),
    );
    blackbox(hi_sink);
  },
  OPS,
