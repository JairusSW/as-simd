...
bench("eq.lib", () => { blackbox(i8x8.eq(blackbox(a), blackbox(b))); }, OPS, 8); dumpToFile("eq-comp", "lib");
bench("eq.current", () => { blackbox(eq_current(blackbox(a), blackbox(b))); }, OPS, 8); dumpToFile("eq-comp", "current");
bench("eq.ne-inverse", () => { blackbox(eq_ne_inverse(blackbox(a), blackbox(b))); }, OPS, 8); dumpToFile("eq-comp", "ne-inverse");
bench("eq.ne-xor-highbit", () => { blackbox(eq_ne_xor_highbit(blackbox(a), blackbox(b))); }, OPS, 8); dumpToFile("eq-comp", "ne-xor-highbit");
bench("eq.current-split32", () => { blackbox(eq_current_split32(blackbox(a), blackbox(b))); }, OPS, 8); dumpToFile("eq-comp", "current-split32");
bench("eq.current-split16", () => { blackbox(eq_current_split16(blackbox(a), blackbox(b))); }, OPS, 8); dumpToFile("eq-comp", "current-split16");
bench("eq.split-nonzero", () => { blackbox(eq_split_nonzero(blackbox(a), blackbox(b))); }, OPS, 8); dumpToFile("eq-comp", "split-nonzero");
