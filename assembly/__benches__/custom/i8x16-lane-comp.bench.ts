...
bench(
  "i8x16.extract-s.lib",
  () => {
    blackbox(extract_s_lib(blackbox(lo), blackbox(hi), blackbox(idx)));
  },
  OPS,
  8,
);
...
bench(
  "i8x16.extract-s.if",
  () => {
    blackbox(extract_s_if(blackbox(lo), blackbox(hi), blackbox(idx)));
  },
  OPS,
  8,
);
...
bench(
  "i8x16.extract-s.select",
  () => {
    blackbox(extract_s_select(blackbox(lo), blackbox(hi), blackbox(idx)));
  },
  OPS,
  8,
);
...
bench(
  "i8x16.extract-u.lib",
  () => {
    blackbox(extract_u_lib(blackbox(lo), blackbox(hi), blackbox(idx)));
  },
  OPS,
  8,
);
...
bench(
  "i8x16.extract-u.if",
  () => {
    blackbox(extract_u_if(blackbox(lo), blackbox(hi), blackbox(idx)));
  },
  OPS,
  8,
);
...
bench(
  "i8x16.extract-u.select",
  () => {
    blackbox(extract_u_select(blackbox(lo), blackbox(hi), blackbox(idx)));
  },
  OPS,
  8,
);
...
bench(
  ...
  () => {
    blackbox(
      replace_lib(blackbox(lo), blackbox(hi), blackbox(idx), blackbox(value)),
    );
    blackbox(hi_sink);
  },
  OPS,
...
bench(
  ...
  () => {
    blackbox(
      replace_if(blackbox(lo), blackbox(hi), blackbox(idx), blackbox(value)),
    );
    blackbox(hi_sink);
  },
  OPS,
...
bench(
  ...
  () => {
    blackbox(
      replace_split(blackbox(lo), blackbox(hi), blackbox(idx), blackbox(value)),
    );
    blackbox(hi_sink);
  },
  OPS,
