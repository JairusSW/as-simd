...
bench(
  "min-s.lib",
  () => {
    blackbox(i8x8.min_s(blackbox(a), blackbox(b)));
  },
  OPS,
  8,
);
dumpToFile("min-s-comp", "lib");
bench(
  "min-s.current",
  () => {
    blackbox(min_s_current(blackbox(a), blackbox(b)));
  },
  OPS,
  8,
);
dumpToFile("min-s-comp", "current");
bench(
  "min-s.split16",
  () => {
    blackbox(min_s_split16(blackbox(a), blackbox(b)));
  },
  OPS,
  8,
);
dumpToFile("min-s-comp", "split16");
bench(
  "min-s.via-lt",
  () => {
