...
dumpToFile("lt-s-comp", "lib");
bench(
  "lt-s.current",
  () => {
    blackbox(lt_s_current(blackbox(a), blackbox(b)));
  },
  OPS,
  8,
);
dumpToFile("lt-s-comp", "current");
bench(
  "lt-s.split16",
  () => {
    blackbox(lt_s_split16(blackbox(a), blackbox(b)));
  },
  OPS,
  8,
);
dumpToFile("lt-s-comp", "split16");
bench(
  "lt-s.split32",
  () => {
    blackbox(lt_s_split32(blackbox(a), blackbox(b)));
  },
  OPS,
  8,
);
dumpToFile("lt-s-comp", "split32");
