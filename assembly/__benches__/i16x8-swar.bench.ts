...
bench("i16x8.splat", () => sinkPair(i16x8_swar.splat(blackbox(X))), OPS, 8);
dumpToFile("i16x8", "splat");
bench(
  "i16x8.extract_lane_s",
  () => blackbox(i16x8_swar.extract_lane_s(blackbox(A_LO), blackbox(A_HI), 5)),
  OPS,
  8,
);
...
bench(
  ...
  () => blackbox(i16x8_swar.extract_lane_u(blackbox(A_LO), blackbox(A_HI), 5)),
  OPS,
  8,
);
...
bench(
  ...
  () =>
    sinkPair(
      i16x8_swar.replace_lane(blackbox(A_LO), blackbox(A_HI), 5, blackbox(X)),
    ),
  OPS,
  8,
);
...
bench(
  "i16x8.abs",
  () => sinkPair(i16x8_swar.abs(blackbox(A_LO), blackbox(A_HI))),
  OPS,
  8,
);
...
bench(
  "i16x8.neg",
  () => sinkPair(i16x8_swar.neg(blackbox(A_LO), blackbox(A_HI))),
  OPS,
  8,
);
...
bench(
  "i16x8.shl",
  () =>
    sinkPair(i16x8_swar.shl(blackbox(A_LO), blackbox(A_HI), blackbox(SHIFT))),
  OPS,
  8,
);
...
bench(
  "i16x8.shr_s",
  () =>
    sinkPair(i16x8_swar.shr_s(blackbox(A_LO), blackbox(A_HI), blackbox(SHIFT))),
  OPS,
  8,
);
...
bench(
  "i16x8.shr_u",
  () =>
    sinkPair(i16x8_swar.shr_u(blackbox(A_LO), blackbox(A_HI), blackbox(SHIFT))),
  OPS,
  8,
);
...
bench(
  "i16x8.all_true",
  () => blackbox(i16x8_swar.all_true(blackbox(A_LO), blackbox(A_HI))),
  OPS,
  8,
);
...
bench(
  "i16x8.bitmask",
  () => blackbox(i16x8_swar.bitmask(blackbox(A_LO), blackbox(A_HI))),
  OPS,
  8,
);
