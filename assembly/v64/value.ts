...
@inline function mem_load<T>(ptr: usize, immAlign: usize = 1): T {
  return load<T>(ptr);
}
// @ts-expect-error: decorator
@inline function mem_store<T>(ptr: usize, value: T, immAlign: usize = 1): void {
  store<T>(ptr, value);
}
// @ts-expect-error: decorator
@inline function f32_trunc(x: f32): f32 {
  return trunc(x);
}
// @ts-expect-error: decorator
@inline function f64_trunc(x: f64): f64 {
  return trunc(x);
}
// @ts-expect-error: decorator
@inline function f32_nearest(x: f32): f32 {
  return nearest(x);
}
// @ts-expect-error: decorator
@inline function f64_nearest(x: f64): f64 {
  return nearest(x);
}
...
export namespace v64 {
  ...
  @inline function popcnt64(x: u64): u64 {
    return (popcnt32((x & 0xffffffff) as u32) +
      popcnt32((x >> 32) as u32)) as u64;
  }
  ...
  @inline export function extract_lane<T>(x: v64, idx: u8): T {
    ...
    if (sizeof<T>() == 2) {
      return (
        isSigned<T>()
          ? i16x4.extract_lane_s(x, idx & 3)
          : i16x4.extract_lane_u(x, idx & 3)
      ) as T;
    }
  ...
  export function shuffle<T>(a: v64, b: v64, lanes: StaticArray<u8>): v64 {
    ...
    while (i < n) {
      ...
      const val =
        lane < n
          ? extract_lane<T>(a, lane as u8)
          : extract_lane<T>(b, (lane - n) as u8);
  ...
  @inline export function load_ext<TFrom>(
    ...
    if (sizeof<TFrom>() == 1) {
      ...
      return isSigned<TFrom>()
        ? i16x4.extend_low_i8x8_s(base)
        : i16x4.extend_low_i8x8_u(base);
    }
    if (sizeof<TFrom>() == 2) {
      const base = mem_load<u32>(p, immAlign) as v64;
      return isSigned<TFrom>()
        ? i32x2.extend_low_i16x4_s(base)
        : i32x2.extend_low_i16x4_u(base);
    }
    if (sizeof<TFrom>() == 4) {
  ...
  // @ts-expect-error: decorator
  @inline export function load8x4_s(
    ptr: usize,
    immOffset: usize = 0,
    immAlign: usize = 1,
  ): v64 {
    return load_ext<i8>(ptr, immOffset, immAlign);
  }
  /** Creates a vector with four 16-bit lanes by loading and zero extending four 8-bit integers. */
  // @ts-expect-error: decorator
  @inline export function load8x4_u(
    ptr: usize,
    immOffset: usize = 0,
    immAlign: usize = 1,
  ): v64 {
    return load_ext<u8>(ptr, immOffset, immAlign);
  }
  /** Creates a vector with two 32-bit lanes by loading and sign extending two 16-bit integers. */
  // @ts-expect-error: decorator
  @inline export function load16x2_s(
    ptr: usize,
    immOffset: usize = 0,
    immAlign: usize = 1,
  ): v64 {
    return load_ext<i16>(ptr, immOffset, immAlign);
  }
  /** Creates a vector with two 32-bit lanes by loading and zero extending two 16-bit integers. */
  // @ts-expect-error: decorator
  @inline export function load16x2_u(
    ptr: usize,
    immOffset: usize = 0,
    immAlign: usize = 1,
  ): v64 {
    return load_ext<u16>(ptr, immOffset, immAlign);
  }
  /** Creates a vector with one 64-bit lane by loading and sign extending one 32-bit integer. */
  // @ts-expect-error: decorator
  @inline export function load32x1_s(
    ptr: usize,
    immOffset: usize = 0,
    immAlign: usize = 1,
  ): v64 {
    return load_ext<i32>(ptr, immOffset, immAlign);
  }
  /** Creates a vector with one 64-bit lane by loading and zero extending one 32-bit integer. */
  // @ts-expect-error: decorator
  @inline export function load32x1_u(
    ptr: usize,
    immOffset: usize = 0,
    immAlign: usize = 1,
  ): v64 {
    return load_ext<u32>(ptr, immOffset, immAlign);
  }
  ...
  @inline export function load8x8_s(
    ...
    return load8x4_s(ptr, immOffset, immAlign);
  }
  /** Creates a vector with four 16-bit lanes by loading and zero extending four 8-bit integers. */
  // @ts-expect-error: decorator
  @inline export function load8x8_u(
    ...
    return load8x4_u(ptr, immOffset, immAlign);
  }
  /** Creates a vector with two 32-bit lanes by loading and sign extending two 16-bit integers. */
  // @ts-expect-error: decorator
  @inline export function load16x4_s(
    ...
    return load16x2_s(ptr, immOffset, immAlign);
  }
  /** Creates a vector with two 32-bit lanes by loading and zero extending two 16-bit integers. */
  // @ts-expect-error: decorator
  @inline export function load16x4_u(
    ...
    return load16x2_u(ptr, immOffset, immAlign);
  }
  /** Creates a vector with one 64-bit lane by loading and sign extending one 32-bit integer. */
  // @ts-expect-error: decorator
  @inline export function load32x2_s(
    ...
    return load32x1_s(ptr, immOffset, immAlign);
  }
  /** Creates a vector with one 64-bit lane by loading and zero extending one 32-bit integer. */
  // @ts-expect-error: decorator
  @inline export function load32x2_u(
    ...
    return load32x1_u(ptr, immOffset, immAlign);
  }
  ...
  @inline export function load_splat<T>(
    ...
    return splat<T>(mem_load<T>(ptr + immOffset, immAlign));
  }
  ...
  @inline export function load8_splat(
    ...
    return splat<i8>(mem_load<i8>(ptr + immOffset, immAlign));
  }
  ...
  @inline export function load16_splat(
    ...
    return splat<i16>(mem_load<i16>(ptr + immOffset, immAlign));
  }
  ...
  @inline export function load32_splat(
    ...
    return splat<i32>(mem_load<i32>(ptr + immOffset, immAlign));
  }
  ...
  @inline export function load64_splat(
    ...
    return splat<i64>(mem_load<i64>(ptr + immOffset, immAlign));
  }
  ...
  @inline export function load8_lane(
    ...
    return load_lane<i8>(ptr, vec, idx, immOffset, immAlign);
  }
  ...
  @inline export function load16_lane(
    ...
    return load_lane<i16>(ptr, vec, idx, immOffset, immAlign);
  }
  ...
  @inline export function load32_lane(
    ...
    return load_lane<i32>(ptr, vec, idx, immOffset, immAlign);
  }
  ...
  @inline export function load64_lane(
    ...
    return load_lane<i64>(ptr, vec, idx, immOffset, immAlign);
  }
  ...
  @inline export function store8_lane(
    ...
    store_lane<i8>(ptr, vec, idx, immOffset, immAlign);
  }
  ...
  @inline export function store16_lane(
    ...
    store_lane<i16>(ptr, vec, idx, immOffset, immAlign);
  }
  ...
  @inline export function store32_lane(
    ...
    store_lane<i32>(ptr, vec, idx, immOffset, immAlign);
  }
  ...
  @inline export function store64_lane(
    ...
    store_lane<i64>(ptr, vec, idx, immOffset, immAlign);
  }
  ...
  @inline export function store(
    ...
    mem_store<v64>(ptr + immOffset, value, immAlign);
  }
  ...
  @inline export function add<T>(a: v64, b: v64): v64 {
    if (isFloat<T>()) {
      if (sizeof<T>() == 4)
        return set_f32_lane(
          set_f32_lane(0, 0, f32_lane(a, 0) + f32_lane(b, 0)),
          1,
          f32_lane(a, 1) + f32_lane(b, 1),
        );
  ...
  @inline export function add_sat<T>(a: v64, b: v64): v64 {
    if (sizeof<T>() == 1)
      return isSigned<T>() ? i8x8.add_sat_s(a, b) : i8x8.add_sat_u(a, b);
    if (sizeof<T>() == 2)
      return isSigned<T>() ? i16x4.add_sat_s(a, b) : i16x4.add_sat_u(a, b);
    return add<T>(a, b);
  }
  ...
  @inline export function sub_sat<T>(a: v64, b: v64): v64 {
    if (sizeof<T>() == 1)
      return isSigned<T>() ? i8x8.sub_sat_s(a, b) : i8x8.sub_sat_u(a, b);
    if (sizeof<T>() == 2)
      return isSigned<T>() ? i16x4.sub_sat_s(a, b) : i16x4.sub_sat_u(a, b);
    return sub<T>(a, b);
  }
  ...
  @inline export function shr<T>(a: v64, b: i32): v64 {
    if (sizeof<T>() == 1)
      return isSigned<T>() ? i8x8.shr_s(a, b) : i8x8.shr_u(a, b);
    if (sizeof<T>() == 2)
      return isSigned<T>() ? i16x4.shr_s(a, b) : i16x4.shr_u(a, b);
    if (sizeof<T>() == 4)
      return isSigned<T>() ? i32x2.shr_s(a, b) : i32x2.shr_u(a, b);
    return isSigned<T>()
      ? (((a as i64) >> (b & 63)) as v64)
      : (((a as u64) >> (b & 63)) as v64);
  }
  /** Computes bitwise AND of two vectors. */
  // @ts-expect-error: decorator
  @inline export function and(a: v64, b: v64): v64 {
    return a & b;
  }
  /** Computes bitwise OR of two vectors. */
  // @ts-expect-error: decorator
  @inline export function or(a: v64, b: v64): v64 {
    return a | b;
  }
  /** Computes bitwise XOR of two vectors. */
  // @ts-expect-error: decorator
  @inline export function xor(a: v64, b: v64): v64 {
    return a ^ b;
  }
  /** Computes bitwise ANDNOT of two vectors (`a & ~b`). */
  // @ts-expect-error: decorator
  @inline export function andnot(a: v64, b: v64): v64 {
    return a & ~b;
  }
  /** Computes bitwise NOT of a vector. */
  // @ts-expect-error: decorator
  @inline export function not(a: v64): v64 {
    return ~a;
  }
  /** Selects bits from `v1` and `v2` using `mask`. */
  // @ts-expect-error: decorator
  @inline export function bitselect(v1: v64, v2: v64, mask: v64): v64 {
  ...
  @inline export function popcnt<T>(a: v64): v64 {
    ...
    if (sizeof<T>() == 2)
      return i16x4(
        popcnt16((a & 0xffff) as u16) as i16,
        popcnt16(((a >> 16) & 0xffff) as u16) as i16,
        popcnt16(((a >> 32) & 0xffff) as u16) as i16,
        popcnt16(((a >> 48) & 0xffff) as u16) as i16,
      );
    if (sizeof<T>() == 4)
      return i32x2(
        popcnt32((a & 0xffffffff) as u32) as i32,
        popcnt32(((a >> 32) & 0xffffffff) as u32) as i32,
      );
  ...
  @inline export function min<T>(a: v64, b: v64): v64 {
    if (isFloat<T>()) {
      if (sizeof<T>() == 4)
        return set_f32_lane(
          set_f32_lane(0, 0, Mathf.min(f32_lane(a, 0), f32_lane(b, 0))),
          1,
          Mathf.min(f32_lane(a, 1), f32_lane(b, 1)),
        );
      return set_f64_lane(0, Math.min(f64_lane(a), f64_lane(b)));
    }
    if (sizeof<T>() == 1)
      return isSigned<T>() ? i8x8.min_s(a, b) : i8x8.min_u(a, b);
    if (sizeof<T>() == 2)
      return isSigned<T>() ? i16x4.min_s(a, b) : i16x4.min_u(a, b);
    if (sizeof<T>() == 4)
      return isSigned<T>() ? i32x2.min_s(a, b) : i32x2.min_u(a, b);
  ...
  @inline export function max<T>(a: v64, b: v64): v64 {
    if (isFloat<T>()) {
      if (sizeof<T>() == 4)
        return set_f32_lane(
          set_f32_lane(0, 0, Mathf.max(f32_lane(a, 0), f32_lane(b, 0))),
          1,
          Mathf.max(f32_lane(a, 1), f32_lane(b, 1)),
        );
      return set_f64_lane(0, Math.max(f64_lane(a), f64_lane(b)));
    }
    if (sizeof<T>() == 1)
      return isSigned<T>() ? i8x8.max_s(a, b) : i8x8.max_u(a, b);
    if (sizeof<T>() == 2)
      return isSigned<T>() ? i16x4.max_s(a, b) : i16x4.max_u(a, b);
    if (sizeof<T>() == 4)
      return isSigned<T>() ? i32x2.max_s(a, b) : i32x2.max_u(a, b);
    return ((a as i64) > (b as i64) ? a : b) as v64;
  }
  /** Computes pseudo-minimum (alias of `min`). */
  // @ts-expect-error: decorator
  @inline export function pmin<T>(a: v64, b: v64): v64 {
    return min<T>(a, b);
  }
  /** Computes pseudo-maximum (alias of `max`). */
  // @ts-expect-error: decorator
  @inline export function pmax<T>(a: v64, b: v64): v64 {
    return max<T>(a, b);
  }
  /** Computes pairwise dot products for i16 lanes into i32 lanes. */
  // @ts-expect-error: decorator
  @inline export function dot<T>(a: v64, b: v64): v64 {
    return i32x2.dot_i16x4_s(a, b);
  }
  /** Computes unsigned average by lane for u8/u16 shapes. */
  // @ts-expect-error: decorator
  @inline export function avgr<T>(a: v64, b: v64): v64 {
    return sizeof<T>() == 1 ? i8x8.avgr_u(a, b) : i16x4.avgr_u(a, b);
  }
  ...
  @inline export function abs<T>(a: v64): v64 {
    if (isFloat<T>()) {
      if (sizeof<T>() == 4)
        return set_f32_lane(
          set_f32_lane(0, 0, Mathf.abs(f32_lane(a, 0))),
          1,
          Mathf.abs(f32_lane(a, 1)),
        );
  ...
  @inline export function sqrt<T>(a: v64): v64 {
    if (sizeof<T>() == 4)
      return set_f32_lane(
        set_f32_lane(0, 0, Mathf.sqrt(f32_lane(a, 0))),
        1,
        Mathf.sqrt(f32_lane(a, 1)),
      );
  ...
  @inline export function ceil<T>(a: v64): v64 {
    if (sizeof<T>() == 4)
      return set_f32_lane(
        set_f32_lane(0, 0, Mathf.ceil(f32_lane(a, 0))),
        1,
        Mathf.ceil(f32_lane(a, 1)),
      );
  ...
  @inline export function floor<T>(a: v64): v64 {
    if (sizeof<T>() == 4)
      return set_f32_lane(
        set_f32_lane(0, 0, Mathf.floor(f32_lane(a, 0))),
        1,
        Mathf.floor(f32_lane(a, 1)),
      );
  ...
  @inline export function trunc<T>(a: v64): v64 {
    if (sizeof<T>() == 4)
      return set_f32_lane(
        set_f32_lane(0, 0, f32_trunc(f32_lane(a, 0))),
        1,
        f32_trunc(f32_lane(a, 1)),
      );
  ...
  @inline export function nearest<T>(a: v64): v64 {
    if (sizeof<T>() == 4)
      return set_f32_lane(
        set_f32_lane(0, 0, f32_nearest(f32_lane(a, 0))),
        1,
        f32_nearest(f32_lane(a, 1)),
      );
  ...
  @inline export function eq<T>(a: v64, b: v64): v64 {
    if (isFloat<T>()) {
      if (sizeof<T>() == 4)
        return i32x2(
          f32_lane(a, 0) == f32_lane(b, 0) ? -1 : 0,
          f32_lane(a, 1) == f32_lane(b, 1) ? -1 : 0,
        );
  ...
  // @ts-expect-error: decorator
  @inline export function ne<T>(a: v64, b: v64): v64 {
    return ~eq<T>(a, b);
  }
  ...
  @inline export function lt<T>(a: v64, b: v64): v64 {
    ...
    if (sizeof<T>() == 1)
      return isSigned<T>() ? i8x8.lt_s(a, b) : i8x8.lt_u(a, b);
    if (sizeof<T>() == 2)
      return isSigned<T>() ? i16x4.lt_s(a, b) : i16x4.lt_u(a, b);
    if (sizeof<T>() == 4)
      return isSigned<T>() ? i32x2.lt_s(a, b) : i32x2.lt_u(a, b);
    return ((a as i64) < (b as i64) ? -1 : 0) as v64;
  }
  ...
  @inline export function le<T>(a: v64, b: v64): v64 {
    if (sizeof<T>() == 1)
      return isSigned<T>() ? i8x8.le_s(a, b) : i8x8.le_u(a, b);
    if (sizeof<T>() == 2)
      return isSigned<T>() ? i16x4.le_s(a, b) : i16x4.le_u(a, b);
    if (sizeof<T>() == 4)
      return isSigned<T>() ? i32x2.le_s(a, b) : i32x2.le_u(a, b);
    return ~lt<T>(b, a);
  }
  /** Computes lane-wise greater-than mask. */
  // @ts-expect-error: decorator
  @inline export function gt<T>(a: v64, b: v64): v64 {
    return lt<T>(b, a);
  }
  /** Computes lane-wise greater-than-or-equal mask. */
  // @ts-expect-error: decorator
  @inline export function ge<T>(a: v64, b: v64): v64 {
    return le<T>(b, a);
  }
  ...
  @inline export function convert<TFrom>(a: v64): v64 {
    if (isSigned<TFrom>())
      return set_f32_lane(
        set_f32_lane(0, 0, i32x2.extract_lane(a, 0) as f32),
        1,
        i32x2.extract_lane(a, 1) as f32,
      );
    return set_f32_lane(
      set_f32_lane(0, 0, i32x2.extract_lane(a, 0) as u32 as f32),
      1,
      i32x2.extract_lane(a, 1) as u32 as f32,
    );
  }
  ...
  @inline export function convert_low<TFrom>(a: v64): v64 {
    if (isSigned<TFrom>())
      return set_f64_lane(0, i32x2.extract_lane(a, 0) as f64);
  ...
  @inline export function trunc_sat<TTo>(a: v64): v64 {
    const x0 = f32_lane(a, 0),
      x1 = f32_lane(a, 1);
    if (isSigned<TTo>()) return i32x2(i32(x0), i32(x1));
    return i32x2(
      u32(select<f32>(0, x0, x0 < 0)),
      u32(select<f32>(0, x1, x1 < 0)),
    );
  }
  ...
  @inline export function narrow<TFrom>(a: v64, b: v64): v64 {
    if (sizeof<TFrom>() == 2)
      return isSigned<TFrom>()
        ? i8x8.narrow_i16x4_s(a, b)
        : i8x8.narrow_i16x4_u(a, b);
    return isSigned<TFrom>()
      ? i16x4.narrow_i32x2_s(a, b)
      : i16x4.narrow_i32x2_u(a, b);
  }
  ...
  @inline export function extend_low<TFrom>(a: v64): v64 {
    if (sizeof<TFrom>() == 1)
      return isSigned<TFrom>()
        ? i16x4.extend_low_i8x8_s(a)
        : i16x4.extend_low_i8x8_u(a);
    if (sizeof<TFrom>() == 2)
      return isSigned<TFrom>()
  ...
  @inline export function extend_high<TFrom>(a: v64): v64 {
    if (sizeof<TFrom>() == 1)
      return isSigned<TFrom>()
        ? i16x4.extend_high_i8x8_s(a)
        : i16x4.extend_high_i8x8_u(a);
    if (sizeof<TFrom>() == 2)
      return isSigned<TFrom>()
  ...
  @inline export function extadd_pairwise<TFrom>(a: v64): v64 {
    if (sizeof<TFrom>() == 1)
      return isSigned<TFrom>()
        ? i16x4.extadd_pairwise_i8x8_s(a)
        : i16x4.extadd_pairwise_i8x8_u(a);
    return isSigned<TFrom>()
  ...
  // @ts-expect-error: decorator
  @inline export function demote_zero<T>(a: v64): v64 {
    return set_f32_lane(set_f32_lane(0, 0, f64_lane(a) as f32), 1, 0);
  }
  /** Promotes low f32 lane to f64. */
  // @ts-expect-error: decorator
  @inline export function promote_low<T>(a: v64): v64 {
    return set_f64_lane(0, f32_lane(a, 0) as f64);
  }
  /** Performs signed Q15 rounding multiply with saturation. */
  // @ts-expect-error: decorator
  @inline export function q15mulr_sat<T>(a: v64, b: v64): v64 {
    return i16x4.q15mulr_sat_s(a, b);
  }
  ...
  @inline export function extmul_low<T>(a: v64, b: v64): v64 {
    if (sizeof<T>() == 1)
      return isSigned<T>()
        ? i16x4.extmul_low_i8x8_s(a, b)
        : i16x4.extmul_low_i8x8_u(a, b);
    if (sizeof<T>() == 2)
      return isSigned<T>()
  ...
  @inline export function extmul_high<T>(a: v64, b: v64): v64 {
    if (sizeof<T>() == 1)
      return isSigned<T>()
        ? i16x4.extmul_high_i8x8_s(a, b)
        : i16x4.extmul_high_i8x8_u(a, b);
    if (sizeof<T>() == 2)
      return isSigned<T>()
  ...
  @inline export function relaxed_swizzle(a: v64, s: v64): v64 {
    return i8x8.relaxed_swizzle(a, s);
  }
  /** Relaxed truncation from f32 lanes to integer lanes. */
  // @ts-expect-error: decorator
  @inline export function relaxed_trunc<T>(a: v64): v64 {
    return trunc_sat<T>(a);
  }
  /** Relaxed truncation from low f64 lane to integer lane. */
  // @ts-expect-error: decorator
  @inline export function relaxed_trunc_zero<T>(a: v64): v64 {
    return trunc_sat_zero<T>(a);
  }
  /** Relaxed fused multiply-add (`a * b + c`). */
  // @ts-expect-error: decorator
  @inline export function relaxed_madd<T>(a: v64, b: v64, c: v64): v64 {
    return add<T>(mul<T>(a, b), c);
  }
  /** Relaxed fused negative multiply-add (`-(a * b) + c`). */
  // @ts-expect-error: decorator
  @inline export function relaxed_nmadd<T>(a: v64, b: v64, c: v64): v64 {
    return add<T>(neg<T>(mul<T>(a, b)), c);
  }
  ...
  // @ts-expect-error: decorator
  @inline export function relaxed_min<T>(a: v64, b: v64): v64 {
    return min<T>(a, b);
  }
  /** Relaxed maximum (alias of `max`). */
  // @ts-expect-error: decorator
  @inline export function relaxed_max<T>(a: v64, b: v64): v64 {
    return max<T>(a, b);
  }
  /** Relaxed Q15 multiply (alias of `q15mulr_sat`). */
  // @ts-expect-error: decorator
  @inline export function relaxed_q15mulr<T>(a: v64, b: v64): v64 {
    return q15mulr_sat<i16>(a, b);
  }
  /** Relaxed dot product (alias of `dot`). */
  // @ts-expect-error: decorator
  @inline export function relaxed_dot<T>(a: v64, b: v64): v64 {
    return dot<i16>(a, b);
  }
  /** Relaxed dot product plus accumulation. */
  // @ts-expect-error: decorator
  @inline export function relaxed_dot_add<T>(a: v64, b: v64, c: v64): v64 {
    return add<i32>(dot<i16>(a, b), c);
  }
}
