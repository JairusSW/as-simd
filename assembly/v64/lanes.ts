...
export namespace i8x8 {
  ...
  @inline function mul_swar(a: v64, b: v64): v64 {
    ...
    const p1 =
      (((((a >> 16) & 0xff) * ((b >> 16) & 0xff)) & 0xff) |
        (((((a >> 24) & 0xff) * ((b >> 24) & 0xff)) & 0xff) << 8)) <<
      16;
    const p2 =
      (((((a >> 32) & 0xff) * ((b >> 32) & 0xff)) & 0xff) |
        (((((a >> 40) & 0xff) * ((b >> 40) & 0xff)) & 0xff) << 8)) <<
      32;
    const p3 =
      (((((a >> 48) & 0xff) * ((b >> 48) & 0xff)) & 0xff) |
        (((((a >> 56) & 0xff) * ((b >> 56) & 0xff)) & 0xff) << 8)) <<
      48;
    return p0 | p1 | p2 | p3;
  }
  ...
  @inline export function loadPartial(
    ...
    switch (len) {
      case 1:
        return (fv & 0xffffffffffffff00) | (load<u8>(p) as v64);
      case 2:
        return (fv & 0xffffffffffff0000) | (load<u16>(p) as v64);
      case 3:
        return (
          (fv & 0xffffffffff000000) |
          (load<u16>(p) as v64) |
          ((load<u8>(p, 2) as v64) << 16)
        );
      case 4:
        return (fv & 0xffffffff00000000) | (load<u32>(p) as v64);
      case 5:
        return (
          (fv & 0xffffff0000000000) |
          (load<u32>(p) as v64) |
          ((load<u8>(p, 4) as v64) << 32)
        );
      case 6:
        return (
          (fv & 0xffff000000000000) |
          (load<u32>(p) as v64) |
          ((load<u16>(p, 4) as v64) << 32)
        );
      default:
        return (
          (fv & 0xff00000000000000) |
          (load<u32>(p) as v64) |
          ((load<u16>(p, 4) as v64) << 32) |
          ((load<u8>(p, 6) as v64) << 48)
        );
    }
  }
  ...
  @inline export function mul(a: v64, b: v64): v64 {
    if (ASC_FEATURE_SIMD) {
      const product = i16x8.extmul_low_i8x16_u(
        i64x2(a as i64, 0),
        i64x2(b as i64, 0),
      );
  ...
  @inline export function min_u(a: v64, b: v64): v64 {
    const d =
      ...
      ((a ^ ~b) & 0x8080808080808080);
    const mask =
      ((((~a & b) | (~(a ^ b) & d)) & 0x8080808080808080) >> 7) * 0xff;
    return b ^ ((a ^ b) & mask);
  }
  ...
  @inline export function neg(a: v64): v64 {
    ...
    return (
      (0x8080808080808080 - (a & ~0x8080808080808080)) ^
  ...
  @inline export function add_sat_u(a: v64, b: v64): v64 {
    ...
    const hi =
      ((a >> 8) & 0x00ff00ff00ff00ff) + ((b >> 8) & 0x00ff00ff00ff00ff);
  ...
  @inline export function shr_u(a: v64, b: i32): v64 {
    switch (b & 7) {
      case 0:
        return a;
      case 1:
        return (a >> 1) & 0x7f7f7f7f7f7f7f7f;
      case 2:
        return (a >> 2) & 0x3f3f3f3f3f3f3f3f;
      case 3:
        return (a >> 3) & 0x1f1f1f1f1f1f1f1f;
      case 4:
        return (a >> 4) & 0x0f0f0f0f0f0f0f0f;
      case 5:
        return (a >> 5) & 0x0707070707070707;
      case 6:
        return (a >> 6) & 0x0303030303030303;
      default:
        return (a >> 7) & 0x0101010101010101;
    }
  }
  ...
  @inline export function lt_s(a: v64, b: v64): v64 {
    if (ASC_FEATURE_SIMD) {
      return i64x2.extract_lane(
        i8x16.lt_s(i64x2(a as i64, 0), i64x2(b as i64, 0)),
        0,
      ) as v64;
    }
    const ax = a ^ 0x8080808080808080;
  ...
  @inline export function le_s(a: v64, b: v64): v64 {
    if (ASC_FEATURE_SIMD) {
      return i64x2.extract_lane(
        i8x16.le_s(i64x2(a as i64, 0), i64x2(b as i64, 0)),
        0,
      ) as v64;
    }
    const bx = b ^ 0x8080808080808080;
  ...
  @inline export function le_u(a: v64, b: v64): v64 {
    if (ASC_FEATURE_SIMD) {
      return i64x2.extract_lane(
        i8x16.le_u(i64x2(a as i64, 0), i64x2(b as i64, 0)),
        0,
      ) as v64;
    }
    const d =
      ((b | 0x8080808080808080) - (a & 0x7f7f7f7f7f7f7f7f)) ^
      ((b ^ ~a) & 0x8080808080808080);
  ...
  @inline export function ge_s(a: v64, b: v64): v64 {
    if (ASC_FEATURE_SIMD) {
      return i64x2.extract_lane(
        i8x16.ge_s(i64x2(a as i64, 0), i64x2(b as i64, 0)),
        0,
      ) as v64;
    }
    const ax = a ^ 0x8080808080808080;
  ...
  @inline export function ge_u(a: v64, b: v64): v64 {
    if (ASC_FEATURE_SIMD) {
      return i64x2.extract_lane(
        i8x16.ge_u(i64x2(a as i64, 0), i64x2(b as i64, 0)),
        0,
      ) as v64;
    }
    const d =
  ...
  @inline export function narrow_i16x4_s(a: v64, b: v64): v64 {
    if (ASC_FEATURE_SIMD) {
      return i64x2.extract_lane(
        i8x16.narrow_i16x8_s(i64x2(a as i64, b as i64), i64x2(0, 0)),
        0,
      ) as v64;
    }
    return (
  ...
  @inline export function narrow_i16x4_u(a: v64, b: v64): v64 {
    if (ASC_FEATURE_SIMD) {
      return i64x2.extract_lane(
        i8x16.narrow_i16x8_u(i64x2(a as i64, b as i64), i64x2(0, 0)),
        0,
      ) as v64;
    }
    return (
  ...
  @inline export function shuffle(
    ...
    const i0 = (l0 & 7) as v64,
      i1 = (l1 & 7) as v64,
      i2 = (l2 & 7) as v64,
      i3 = (l3 & 7) as v64;
    const i4 = (l4 & 7) as v64,
      i5 = (l5 & 7) as v64,
      i6 = (l6 & 7) as v64,
      i7 = (l7 & 7) as v64;
  ...
  @inline export function swizzle(a: v64, s: v64): v64 {
    if (ASC_FEATURE_SIMD) {
      return i64x2.extract_lane(
        i8x16.swizzle(i64x2(a as i64, 0), i64x2(s as i64, 0)),
        0,
      ) as v64;
    }
    ...
    const valid =
      ((~(
        ((x & 0x7f7f7f7f7f7f7f7f) + 0x7f7f7f7f7f7f7f7f) &
        0x8080808080808080
      ) &
        ~x &
        0x8080808080808080) >>
  ...
  @inline export function relaxed_swizzle(a: v64, s: v64): v64 {
    if (ASC_FEATURE_SIMD) {
      return i64x2.extract_lane(
        i8x16.swizzle(
          i64x2(a as i64, 0),
          i64x2((s & 0x0707070707070707) as i64, 0),
        ),
        0,
      ) as v64;
    }
...
export namespace i16x4 {
  ...
  @inline export function add(a: v64, b: v64): v64 {
    ...
    return (
      ((a & ~0x8000800080008000) + (b & ~0x8000800080008000)) ^
      ((a ^ b) & 0x8000800080008000)
    );
  }
  ...
  @inline export function mul(a: v64, b: v64): v64 {
    return (
      ((((a & 0xffff) * (b & 0xffff)) & 0xffff) as v64) |
      ((((((a >> 16) & 0xffff) * ((b >> 16) & 0xffff)) & 0xffff) as v64) <<
        16) |
      ((((((a >> 32) & 0xffff) * ((b >> 32) & 0xffff)) & 0xffff) as v64) <<
        32) |
  ...
  @inline export function min_s(a: v64, b: v64): v64 {
    ...
    const d =
      ((ax | 0x8000800080008000) - (bx & 0x7fff7fff7fff7fff)) ^
      ((ax ^ ~bx) & 0x8000800080008000);
    const mask =
      ((((~ax & bx) | (~(ax ^ bx) & d)) & 0x8000800080008000) >> 15) * 0xffff;
    return b ^ ((a ^ b) & mask);
  }
  ...
  @inline export function min_u(a: v64, b: v64): v64 {
    const d =
      ((a | 0x8000800080008000) - (b & 0x7fff7fff7fff7fff)) ^
      ((a ^ ~b) & 0x8000800080008000);
    const mask =
      ((((~a & b) | (~(a ^ b) & d)) & 0x8000800080008000) >> 15) * 0xffff;
    return b ^ ((a ^ b) & mask);
  }
  ...
  @inline export function abs(a: v64): v64 {
    ...
    const x = a ^ mask;
    return (
      ((x | 0x8000800080008000) - (mask & 0x7fff7fff7fff7fff)) ^
      ((x ^ ~mask) & 0x8000800080008000)
    );
  }
  ...
  @inline export function neg(a: v64): v64 {
    ...
    return (
      (0x8000800080008000 - (a & 0x7fff7fff7fff7fff)) ^
  ...
  @inline export function add_sat_s(a: v64, b: v64): v64 {
    ...
    const limit =
      (((a & 0x8000800080008000) >> 15) * 0xffff) ^ 0x7fff7fff7fff7fff;
    return (sum & ~mask) | (limit & mask);
  }
  ...
  @inline export function add_sat_u(a: v64, b: v64): v64 {
    const sum =
      ...
      ((a ^ b) & 0x8000800080008000);
    const d =
      ((sum | 0x8000800080008000) - (a & 0x7fff7fff7fff7fff)) ^
      ((sum ^ ~a) & 0x8000800080008000);
    const mask =
      ((((~sum & a) | (~(sum ^ a) & d)) & 0x8000800080008000) >> 15) * 0xffff;
    return sum | mask;
  }
  ...
  @inline export function shl(a: v64, b: i32): v64 {
    ...
    if (shift == 0) return a;
    return (
      ((a & (((0xffff >> shift) as v64) * 0x0001000100010001)) << shift) &
      0xffffffffffffffff
    );
  }
  ...
  @inline export function shr_u(a: v64, b: i32): v64 {
    ...
    if (shift == 0) return a;
    return (
      (a & ((((0xffff << shift) & 0xffff) as v64) * 0x0001000100010001)) >>
      shift
    );
  }
  ...
  @inline export function bitmask_lane(a: v64): v64 {
    return (
      (((a & 0x7fff7fff7fff7fff) + 0x7fff7fff7fff7fff) | a) & 0x8000800080008000
    );
  }
  ...
  @inline export function eq(a: v64, b: v64): v64 {
    if (ASC_FEATURE_SIMD) {
      return i64x2.extract_lane(
        i16x8.eq(i64x2(a as i64, 0), i64x2(b as i64, 0)),
        0,
      ) as v64;
    }
    const x = a ^ b;
    const mask =
      (((x & 0x7fff7fff7fff7fff) + 0x7fff7fff7fff7fff) | x) &
      0x8000800080008000;
  ...
  @inline export function lt_s(a: v64, b: v64): v64 {
    if (ASC_FEATURE_SIMD) {
      return i64x2.extract_lane(
        i16x8.lt_s(i64x2(a as i64, 0), i64x2(b as i64, 0)),
        0,
      ) as v64;
    }
    const ax = a ^ 0x8000800080008000;
  ...
  @inline export function le_s(a: v64, b: v64): v64 {
    if (ASC_FEATURE_SIMD) {
      return i64x2.extract_lane(
        i16x8.le_s(i64x2(a as i64, 0), i64x2(b as i64, 0)),
        0,
      ) as v64;
    }
    ...
    const d =
      ...
      ((ax ^ ~bx) & 0x8000800080008000);
    return ~(
      ((((~ax & bx) | (~(ax ^ bx) & d)) & 0x8000800080008000) >> 15) *
      0xffff
    );
  }
  ...
  @inline export function le_u(a: v64, b: v64): v64 {
    if (ASC_FEATURE_SIMD) {
      return i64x2.extract_lane(
        i16x8.le_u(i64x2(a as i64, 0), i64x2(b as i64, 0)),
        0,
      ) as v64;
    }
    const d =
      ((b | 0x8000800080008000) - (a & 0x7fff7fff7fff7fff)) ^
      ((b ^ ~a) & 0x8000800080008000);
    return ~(
      ((((~b & a) | (~(b ^ a) & d)) & 0x8000800080008000) >> 15) *
      0xffff
    );
  }
  ...
  @inline export function gt_s(a: v64, b: v64): v64 {
    ...
    const ax = a ^ 0x8000800080008000;
    const d =
      ((bx | 0x8000800080008000) - (ax & 0x7fff7fff7fff7fff)) ^
      ((bx ^ ~ax) & 0x8000800080008000);
    return (
      ((((~bx & ax) | (~(bx ^ ax) & d)) & 0x8000800080008000) >> 15) * 0xffff
    );
  }
  ...
  @inline export function ge_s(a: v64, b: v64): v64 {
    if (ASC_FEATURE_SIMD) {
      return i64x2.extract_lane(
        i16x8.ge_s(i64x2(a as i64, 0), i64x2(b as i64, 0)),
        0,
      ) as v64;
    }
    const ax = a ^ 0x8000800080008000;
  ...
  @inline export function ge_u(a: v64, b: v64): v64 {
    if (ASC_FEATURE_SIMD) {
      return i64x2.extract_lane(
        i16x8.ge_u(i64x2(a as i64, 0), i64x2(b as i64, 0)),
        0,
      ) as v64;
    }
    const d =
      ...
      ((a ^ ~b) & 0x8000800080008000);
    return ~(
      ((((~a & b) | (~(a ^ b) & d)) & 0x8000800080008000) >> 15) *
      0xffff
    );
  }
  ...
  @inline export function narrow_i32x2_s(a: v64, b: v64): v64 {
    ...
    return (
      (((a0 > 32767 ? 32767 : a0 < -32768 ? -32768 : a0) as v64) & 0xffff) |
      ((((a1 > 32767 ? 32767 : a1 < -32768 ? -32768 : a1) as v64) & 0xffff) <<
        16) |
      ((((b0 > 32767 ? 32767 : b0 < -32768 ? -32768 : b0) as v64) & 0xffff) <<
        32) |
      ((((b1 > 32767 ? 32767 : b1 < -32768 ? -32768 : b1) as v64) & 0xffff) <<
        48)
    );
  }
  ...
  @inline export function narrow_i32x2_u(a: v64, b: v64): v64 {
    ...
    const b1 = ((b >> 32) & 0xffffffff) as i32;
    return (
      (((a0 < 0 ? 0 : a0 > 65535 ? 65535 : a0) as v64) & 0xffff) |
  ...
  @inline export function q15mulr_sat_s(a: v64, b: v64): v64 {
    ...
    return (
      (((p0 > 32767 ? 32767 : p0 < -32768 ? -32768 : p0) as v64) & 0xffff) |
      ((((p1 > 32767 ? 32767 : p1 < -32768 ? -32768 : p1) as v64) & 0xffff) <<
        16) |
      ((((p2 > 32767 ? 32767 : p2 < -32768 ? -32768 : p2) as v64) & 0xffff) <<
        32) |
      ((((p3 > 32767 ? 32767 : p3 < -32768 ? -32768 : p3) as v64) & 0xffff) <<
        48)
    );
  }
  ...
  @inline export function shuffle(
    ...
    const i3 = l3 & 3;
    return (
      (((l0 < 4 ? a >> (i0 * 16) : b >> (i0 * 16)) & 0xffff) as v64) |
  ...
  @inline export function relaxed_dot_i8x8_i7x8_s(a: v64, b: v64): v64 {
    const p0 = ((((a >> 0) & 0xff) as i8 as i16) *
      (((b >> 0) & 0xff) as i8 as i16) +
      (((a >> 8) & 0xff) as i8 as i16) *
        (((b >> 8) & 0xff) as i8 as i16)) as i16;
    const p1 = ((((a >> 16) & 0xff) as i8 as i16) *
      (((b >> 16) & 0xff) as i8 as i16) +
      (((a >> 24) & 0xff) as i8 as i16) *
        (((b >> 24) & 0xff) as i8 as i16)) as i16;
    const p2 = ((((a >> 32) & 0xff) as i8 as i16) *
      (((b >> 32) & 0xff) as i8 as i16) +
      (((a >> 40) & 0xff) as i8 as i16) *
        (((b >> 40) & 0xff) as i8 as i16)) as i16;
    const p3 = ((((a >> 48) & 0xff) as i8 as i16) *
      (((b >> 48) & 0xff) as i8 as i16) +
      (((a >> 56) & 0xff) as i8 as i16) *
        (((b >> 56) & 0xff) as i8 as i16)) as i16;
    return (
      ((p0 as v64) & 0xffff) |
      (((p1 as v64) & 0xffff) << 16) |
      (((p2 as v64) & 0xffff) << 32) |
...
export namespace i32x2 {
  ...
  @inline export function loadPartial(
    ...
    return (
      (((fill as v64) & 0xffffffff) << 32) |
      ((load<u32>(p) as v64) & 0xffffffff)
    );
  }
  /** Stores the first `len` lanes to memory. */
  // @ts-expect-error: decorator
  ...
  @inline export function add(a: v64, b: v64): v64 {
    ...
    // wrap costs more than these few scalar ops for a single 64-bit value.
    return (
      ((a & ~0x8000000080000000) + (b & ~0x8000000080000000)) ^
  ...
  @inline export function sub(a: v64, b: v64): v64 {
    // SWAR unconditionally (see `add`).
    return (
      ((a | 0x8000000080000000) - (b & 0x7fffffff7fffffff)) ^
      ((a ^ ~b) & 0x8000000080000000)
    );
  }
  ...
  @inline export function mul(a: v64, b: v64): v64 {
    return (
      ((((a & 0xffffffff) * (b & 0xffffffff)) & 0xffffffff) as v64) |
  ...
  @inline export function min_s(a: v64, b: v64): v64 {
    ...
    const b1 = ((b >> 32) & 0xffffffff) as i32;
    return (
      select<u64>(a0 as u32 as u64, b0 as u32 as u64, a0 < b0) |
  ...
  @inline export function min_u(a: v64, b: v64): v64 {
    ...
    return (
      select<u64>(a0 as u64, b0 as u64, a0 < b0) |
  ...
  @inline export function max_s(a: v64, b: v64): v64 {
    if (ASC_FEATURE_SIMD) {
      return i64x2.extract_lane(
        i32x4.max_s(i64x2(a as i64, 0), i64x2(b as i64, 0)),
        0,
      ) as v64;
    }
    const a0 = (a & 0xffffffff) as i32;
    ...
    const b1 = ((b >> 32) & 0xffffffff) as i32;
    return (
      select<u64>(b0 as u32 as u64, a0 as u32 as u64, a0 < b0) |
  ...
  @inline export function max_u(a: v64, b: v64): v64 {
    if (ASC_FEATURE_SIMD) {
      return i64x2.extract_lane(
        i32x4.max_u(i64x2(a as i64, 0), i64x2(b as i64, 0)),
        0,
      ) as v64;
    }
    const a0 = (a & 0xffffffff) as u32;
    ...
    const b1 = ((b >> 32) & 0xffffffff) as u32;
    return (
      select<u64>(b0 as u64, a0 as u64, a0 < b0) |
  ...
  @inline export function dot_i16x4_s(a: v64, b: v64): v64 {
    ...
    return (
      ((a0 * b0 + a1 * b1) as u32 as v64) |
      (((a2 * b2 + a3 * b3) as u32 as v64) << 32)
    );
  }
  ...
  @inline export function abs(a: v64): v64 {
    ...
    const x = a ^ mask;
    return (
      ((x | 0x8000000080000000) - (mask & 0x7fffffff7fffffff)) ^
      ((x ^ ~mask) & 0x8000000080000000)
    );
  }
  ...
  @inline export function neg(a: v64): v64 {
    ...
    return (
      (0x8000000080000000 - (a & 0x7fffffff7fffffff)) ^
  ...
  @inline export function shl(a: v64, b: i32): v64 {
    ...
    if (shift == 0) return a;
    return (
      ((a & (((0xffffffff >>> shift) as v64) * 0x0000000100000001)) << shift) &
      0xffffffffffffffff
    );
  }
  ...
  @inline export function eq(a: v64, b: v64): v64 {
    if (ASC_FEATURE_SIMD) {
      return i64x2.extract_lane(
        i32x4.eq(i64x2(a as i64, 0), i64x2(b as i64, 0)),
        0,
      ) as v64;
    }
    const x = a ^ b;
    const mask =
      (((x & 0x7fffffff7fffffff) + 0x7fffffff7fffffff) | x) &
      0x8000000080000000;
  ...
  @inline export function ne(a: v64, b: v64): v64 {
    if (ASC_FEATURE_SIMD) {
      return i64x2.extract_lane(
        i32x4.ne(i64x2(a as i64, 0), i64x2(b as i64, 0)),
        0,
      ) as v64;
    }
    const x = a ^ b;
  ...
  @inline export function lt_s(a: v64, b: v64): v64 {
    if (ASC_FEATURE_SIMD) {
      return i64x2.extract_lane(
        i32x4.lt_s(i64x2(a as i64, 0), i64x2(b as i64, 0)),
        0,
      ) as v64;
    }
    const a0 = (a & 0xffffffff) as i32;
    ...
    const b1 = ((b >> 32) & 0xffffffff) as i32;
    return (
      select<v64>(0xffffffff, 0, a0 < b0) |
      (select<v64>(0xffffffff, 0, a1 < b1) << 32)
    );
  }
  ...
  @inline export function lt_u(a: v64, b: v64): v64 {
    const d =
      ...
      ((a ^ ~b) & 0x8000000080000000);
    return (
      ((((~a & b) | (~(a ^ b) & d)) & 0x8000000080000000) >> 31) * 0xffffffff
    );
  }
  ...
  @inline export function le_s(a: v64, b: v64): v64 {
    if (ASC_FEATURE_SIMD) {
      return i64x2.extract_lane(
        i32x4.le_s(i64x2(a as i64, 0), i64x2(b as i64, 0)),
        0,
      ) as v64;
    }
    const a0 = (a & 0xffffffff) as i32;
  ...
  @inline export function le_u(a: v64, b: v64): v64 {
    if (ASC_FEATURE_SIMD) {
      return i64x2.extract_lane(
        i32x4.le_u(i64x2(a as i64, 0), i64x2(b as i64, 0)),
        0,
      ) as v64;
    }
    const a0 = (a & 0xffffffff) as u32;
  ...
  @inline export function gt_s(a: v64, b: v64): v64 {
    if (ASC_FEATURE_SIMD) {
      return i64x2.extract_lane(
        i32x4.gt_s(i64x2(a as i64, 0), i64x2(b as i64, 0)),
        0,
      ) as v64;
    }
    const a0 = (a & 0xffffffff) as i32;
  ...
  @inline export function gt_u(a: v64, b: v64): v64 {
    if (ASC_FEATURE_SIMD) {
      return i64x2.extract_lane(
        i32x4.gt_u(i64x2(a as i64, 0), i64x2(b as i64, 0)),
        0,
      ) as v64;
    }
    const a0 = (a & 0xffffffff) as u32;
  ...
  @inline export function ge_s(a: v64, b: v64): v64 {
    if (ASC_FEATURE_SIMD) {
      return i64x2.extract_lane(
        i32x4.ge_s(i64x2(a as i64, 0), i64x2(b as i64, 0)),
        0,
      ) as v64;
    }
    const a0 = (a & 0xffffffff) as i32;
  ...
  @inline export function ge_u(a: v64, b: v64): v64 {
    if (ASC_FEATURE_SIMD) {
      return i64x2.extract_lane(
        i32x4.ge_u(i64x2(a as i64, 0), i64x2(b as i64, 0)),
        0,
      ) as v64;
    }
    const a0 = (a & 0xffffffff) as u32;
  ...
  @inline export function extend_high_i16x4_u(a: v64): v64 {
    return (
      (((a >> 32) & 0xffff) as v64) | ((((a >> 48) & 0xffff) as v64) << 32)
    );
  }
