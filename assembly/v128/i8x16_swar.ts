...
export namespace i8x16_swar {
  ...
  // @ts-expect-error: decorator
  @inline export function avgr_u(aLo: u64, aHi: u64, bLo: u64, bHi: u64): u64 { return set_pair(build1u(((lane_u(aLo, aHi, 0) + lane_u(bLo, bHi, 0) + 1) >> 1) as u8, ((lane_u(aLo, aHi, 1) + lane_u(bLo, bHi, 1) + 1) >> 1) as u8, ((lane_u(aLo, aHi, 2) + lane_u(bLo, bHi, 2) + 1) >> 1) as u8, ((lane_u(aLo, aHi, 3) + lane_u(bLo, bHi, 3) + 1) >> 1) as u8, ((lane_u(aLo, aHi, 4) + lane_u(bLo, bHi, 4) + 1) >> 1) as u8, ((lane_u(aLo, aHi, 5) + lane_u(bLo, bHi, 5) + 1) >> 1) as u8, ((lane_u(aLo, aHi, 6) + lane_u(bLo, bHi, 6) + 1) >> 1) as u8, ((lane_u(aLo, aHi, 7) + lane_u(bLo, bHi, 7) + 1) >> 1) as u8), build1u(((lane_u(aLo, aHi, 8) + lane_u(bLo, bHi, 8) + 1) >> 1) as u8, ((lane_u(aLo, aHi, 9) + lane_u(bLo, bHi, 9) + 1) >> 1) as u8, ((lane_u(aLo, aHi, 10) + lane_u(bLo, bHi, 10) + 1) >> 1) as u8, ((lane_u(aLo, aHi, 11) + lane_u(bLo, bHi, 11) + 1) >> 1) as u8, ((lane_u(aLo, aHi, 12) + lane_u(bLo, bHi, 12) + 1) >> 1) as u8, ((lane_u(aLo, aHi, 13) + lane_u(bLo, bHi, 13) + 1) >> 1) as u8, ((lane_u(aLo, aHi, 14) + lane_u(bLo, bHi, 14) + 1) >> 1) as u8, ((lane_u(aLo, aHi, 15) + lane_u(bLo, bHi, 15) + 1) >> 1) as u8)); }
  // @ts-expect-error: decorator
  @inline export function abs(aLo: u64, aHi: u64): u64 { return set_pair(build1(abs<i8>(lane_s(aLo, aHi, 0)), abs<i8>(lane_s(aLo, aHi, 1)), abs<i8>(lane_s(aLo, aHi, 2)), abs<i8>(lane_s(aLo, aHi, 3)), abs<i8>(lane_s(aLo, aHi, 4)), abs<i8>(lane_s(aLo, aHi, 5)), abs<i8>(lane_s(aLo, aHi, 6)), abs<i8>(lane_s(aLo, aHi, 7))), build1(abs<i8>(lane_s(aLo, aHi, 8)), abs<i8>(lane_s(aLo, aHi, 9)), abs<i8>(lane_s(aLo, aHi, 10)), abs<i8>(lane_s(aLo, aHi, 11)), abs<i8>(lane_s(aLo, aHi, 12)), abs<i8>(lane_s(aLo, aHi, 13)), abs<i8>(lane_s(aLo, aHi, 14)), abs<i8>(lane_s(aLo, aHi, 15)))); }
  // @ts-expect-error: decorator
  ...
  // @ts-expect-error: decorator
  @inline export function add_sat_s(aLo: u64, aHi: u64, bLo: u64, bHi: u64): u64 { return set_pair(build1(sat_s(lane_s(aLo, aHi, 0) + lane_s(bLo, bHi, 0)), sat_s(lane_s(aLo, aHi, 1) + lane_s(bLo, bHi, 1)), sat_s(lane_s(aLo, aHi, 2) + lane_s(bLo, bHi, 2)), sat_s(lane_s(aLo, aHi, 3) + lane_s(bLo, bHi, 3)), sat_s(lane_s(aLo, aHi, 4) + lane_s(bLo, bHi, 4)), sat_s(lane_s(aLo, aHi, 5) + lane_s(bLo, bHi, 5)), sat_s(lane_s(aLo, aHi, 6) + lane_s(bLo, bHi, 6)), sat_s(lane_s(aLo, aHi, 7) + lane_s(bLo, bHi, 7))), build1(sat_s(lane_s(aLo, aHi, 8) + lane_s(bLo, bHi, 8)), sat_s(lane_s(aLo, aHi, 9) + lane_s(bLo, bHi, 9)), sat_s(lane_s(aLo, aHi, 10) + lane_s(bLo, bHi, 10)), sat_s(lane_s(aLo, aHi, 11) + lane_s(bLo, bHi, 11)), sat_s(lane_s(aLo, aHi, 12) + lane_s(bLo, bHi, 12)), sat_s(lane_s(aLo, aHi, 13) + lane_s(bLo, bHi, 13)), sat_s(lane_s(aLo, aHi, 14) + lane_s(bLo, bHi, 14)), sat_s(lane_s(aLo, aHi, 15) + lane_s(bLo, bHi, 15)))); }
  // @ts-expect-error: decorator
  @inline export function add_sat_u(aLo: u64, aHi: u64, bLo: u64, bHi: u64): u64 { return set_pair(build1u(sat_u(lane_u(aLo, aHi, 0) + lane_u(bLo, bHi, 0)), sat_u(lane_u(aLo, aHi, 1) + lane_u(bLo, bHi, 1)), sat_u(lane_u(aLo, aHi, 2) + lane_u(bLo, bHi, 2)), sat_u(lane_u(aLo, aHi, 3) + lane_u(bLo, bHi, 3)), sat_u(lane_u(aLo, aHi, 4) + lane_u(bLo, bHi, 4)), sat_u(lane_u(aLo, aHi, 5) + lane_u(bLo, bHi, 5)), sat_u(lane_u(aLo, aHi, 6) + lane_u(bLo, bHi, 6)), sat_u(lane_u(aLo, aHi, 7) + lane_u(bLo, bHi, 7))), build1u(sat_u(lane_u(aLo, aHi, 8) + lane_u(bLo, bHi, 8)), sat_u(lane_u(aLo, aHi, 9) + lane_u(bLo, bHi, 9)), sat_u(lane_u(aLo, aHi, 10) + lane_u(bLo, bHi, 10)), sat_u(lane_u(aLo, aHi, 11) + lane_u(bLo, bHi, 11)), sat_u(lane_u(aLo, aHi, 12) + lane_u(bLo, bHi, 12)), sat_u(lane_u(aLo, aHi, 13) + lane_u(bLo, bHi, 13)), sat_u(lane_u(aLo, aHi, 14) + lane_u(bLo, bHi, 14)), sat_u(lane_u(aLo, aHi, 15) + lane_u(bLo, bHi, 15)))); }
  // @ts-expect-error: decorator
  @inline export function sub_sat_s(aLo: u64, aHi: u64, bLo: u64, bHi: u64): u64 { return set_pair(build1(sat_s(lane_s(aLo, aHi, 0) - lane_s(bLo, bHi, 0)), sat_s(lane_s(aLo, aHi, 1) - lane_s(bLo, bHi, 1)), sat_s(lane_s(aLo, aHi, 2) - lane_s(bLo, bHi, 2)), sat_s(lane_s(aLo, aHi, 3) - lane_s(bLo, bHi, 3)), sat_s(lane_s(aLo, aHi, 4) - lane_s(bLo, bHi, 4)), sat_s(lane_s(aLo, aHi, 5) - lane_s(bLo, bHi, 5)), sat_s(lane_s(aLo, aHi, 6) - lane_s(bLo, bHi, 6)), sat_s(lane_s(aLo, aHi, 7) - lane_s(bLo, bHi, 7))), build1(sat_s(lane_s(aLo, aHi, 8) - lane_s(bLo, bHi, 8)), sat_s(lane_s(aLo, aHi, 9) - lane_s(bLo, bHi, 9)), sat_s(lane_s(aLo, aHi, 10) - lane_s(bLo, bHi, 10)), sat_s(lane_s(aLo, aHi, 11) - lane_s(bLo, bHi, 11)), sat_s(lane_s(aLo, aHi, 12) - lane_s(bLo, bHi, 12)), sat_s(lane_s(aLo, aHi, 13) - lane_s(bLo, bHi, 13)), sat_s(lane_s(aLo, aHi, 14) - lane_s(bLo, bHi, 14)), sat_s(lane_s(aLo, aHi, 15) - lane_s(bLo, bHi, 15)))); }
  // @ts-expect-error: decorator
  @inline export function sub_sat_u(aLo: u64, aHi: u64, bLo: u64, bHi: u64): u64 { return set_pair(build1u(sat_u(lane_u(aLo, aHi, 0) - lane_u(bLo, bHi, 0)), sat_u(lane_u(aLo, aHi, 1) - lane_u(bLo, bHi, 1)), sat_u(lane_u(aLo, aHi, 2) - lane_u(bLo, bHi, 2)), sat_u(lane_u(aLo, aHi, 3) - lane_u(bLo, bHi, 3)), sat_u(lane_u(aLo, aHi, 4) - lane_u(bLo, bHi, 4)), sat_u(lane_u(aLo, aHi, 5) - lane_u(bLo, bHi, 5)), sat_u(lane_u(aLo, aHi, 6) - lane_u(bLo, bHi, 6)), sat_u(lane_u(aLo, aHi, 7) - lane_u(bLo, bHi, 7))), build1u(sat_u(lane_u(aLo, aHi, 8) - lane_u(bLo, bHi, 8)), sat_u(lane_u(aLo, aHi, 9) - lane_u(bLo, bHi, 9)), sat_u(lane_u(aLo, aHi, 10) - lane_u(bLo, bHi, 10)), sat_u(lane_u(aLo, aHi, 11) - lane_u(bLo, bHi, 11)), sat_u(lane_u(aLo, aHi, 12) - lane_u(bLo, bHi, 12)), sat_u(lane_u(aLo, aHi, 13) - lane_u(bLo, bHi, 13)), sat_u(lane_u(aLo, aHi, 14) - lane_u(bLo, bHi, 14)), sat_u(lane_u(aLo, aHi, 15) - lane_u(bLo, bHi, 15)))); }
  // @ts-expect-error: decorator
  @inline export function shl(aLo: u64, aHi: u64, b: i32): u64 { const s = b & 7; return set_pair(build1u((lane_u(aLo, aHi, 0) << s) as u8, (lane_u(aLo, aHi, 1) << s) as u8, (lane_u(aLo, aHi, 2) << s) as u8, (lane_u(aLo, aHi, 3) << s) as u8, (lane_u(aLo, aHi, 4) << s) as u8, (lane_u(aLo, aHi, 5) << s) as u8, (lane_u(aLo, aHi, 6) << s) as u8, (lane_u(aLo, aHi, 7) << s) as u8), build1u((lane_u(aLo, aHi, 8) << s) as u8, (lane_u(aLo, aHi, 9) << s) as u8, (lane_u(aLo, aHi, 10) << s) as u8, (lane_u(aLo, aHi, 11) << s) as u8, (lane_u(aLo, aHi, 12) << s) as u8, (lane_u(aLo, aHi, 13) << s) as u8, (lane_u(aLo, aHi, 14) << s) as u8, (lane_u(aLo, aHi, 15) << s) as u8)); }
  // @ts-expect-error: decorator
  @inline export function shr_s(aLo: u64, aHi: u64, b: i32): u64 { const s = b & 7; return set_pair(build1((lane_s(aLo, aHi, 0) >> s) as i8, (lane_s(aLo, aHi, 1) >> s) as i8, (lane_s(aLo, aHi, 2) >> s) as i8, (lane_s(aLo, aHi, 3) >> s) as i8, (lane_s(aLo, aHi, 4) >> s) as i8, (lane_s(aLo, aHi, 5) >> s) as i8, (lane_s(aLo, aHi, 6) >> s) as i8, (lane_s(aLo, aHi, 7) >> s) as i8), build1((lane_s(aLo, aHi, 8) >> s) as i8, (lane_s(aLo, aHi, 9) >> s) as i8, (lane_s(aLo, aHi, 10) >> s) as i8, (lane_s(aLo, aHi, 11) >> s) as i8, (lane_s(aLo, aHi, 12) >> s) as i8, (lane_s(aLo, aHi, 13) >> s) as i8, (lane_s(aLo, aHi, 14) >> s) as i8, (lane_s(aLo, aHi, 15) >> s) as i8)); }
  // @ts-expect-error: decorator
  ...
  @inline export function popcnt(aLo: u64, aHi: u64): u64 {
    ...
    while (i < 16) {
      const p = popcnt<u32>(lane_u(aLo, aHi, i) as u32) as u8;
