...
const VARIANTS: Variant[] = [
  ...
  { key: "i8x8-swar-llvm", color: "rgb(34,197,94)", runtime: "llvm", mode: "swar", suite: SUITE_A },
  { key: "i8x16-simd-v8", color: "rgb(234,220,90)", runtime: "v8", mode: "simd", suite: SUITE_B },
  { key: "i8x16-simd-llvm", color: "rgb(239,68,68)", runtime: "llvm", mode: "simd", suite: SUITE_B },
];
