...
const VARIANTS: [ChartVariant, ChartVariant, ChartVariant, ChartVariant] = [
  ...
  { key: "v128-simd-llvm", color: "rgb(239,68,68)", runtime: "wavm", mode: "simd", suite: "v128" },
];

createComparisonChart({
  root: ROOT,
  id: "v64-swar-v-v128-simd",
  title: "v64 SWAR vs v128 SIMD",
  subtitle: chartSubtitle(ROOT),
  order: ORDER,
  variants: VARIANTS,
  deltaLabel: "v64-v8 vs v128-v8",
  layout: { leftW: 150, rightW: 560 },
  missingRowsMessage: "No overlapping benchmark methods found for v64 (swar) and v128 (simd) in build/logs/as",
});
