...
const VARIANTS: Variant[] = [
  ...
  { key: "i16x4-swar-llvm", color: "rgb(34,197,94)", runtime: "llvm", mode: "swar", suite: SUITE_A },
  { key: "i16x8-simd-v8", color: "rgb(234,220,90)", runtime: "v8", mode: "simd", suite: SUITE_B },
  { key: "i16x8-simd-llvm", color: "rgb(239,68,68)", runtime: "llvm", mode: "simd", suite: SUITE_B },
];
...
for (const v of VARIANTS) for (const op of Object.keys(loaded[v.key])) if (!seen.has(op)) { seen.add(op); orderedOps.push(op); }
