...
const MD_OUT = path.join(CHARTS_DIR, "chart-i32x4-swar-v-i32x4-simd.md");
const SVG_OUT = path.join(CHARTS_DIR, "chart-i32x4-swar-v-i32x4-simd.svg");
const TITLE = "i32x4 SWAR vs SIMD";
const SUBTITLE = chartSubtitle(ROOT);

const SUITE_SWAR = "i32x4";
const SUITE_SIMD = "i32x4";
const ORDER = [
...
const VARIANTS: Variant[] = [
  { key: "i32x4-swar-v8", color: "rgb(99,102,241)", runtime: "v8", mode: "swar", suite: SUITE_SWAR },
  { key: "i32x4-swar-wavm", color: "rgb(34,197,94)", runtime: "wavm", mode: "swar", suite: SUITE_SWAR },
  { key: "i32x4-simd-v8", color: "rgb(234,220,90)", runtime: "v8", mode: "simd", suite: SUITE_SIMD },
  { key: "i32x4-simd-wavm", color: "rgb(239,68,68)", runtime: "wavm", mode: "simd", suite: SUITE_SIMD },
];
