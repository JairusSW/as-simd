...
const MD_OUT = path.join(CHARTS_DIR, "chart-v128-swar-v-v128-simd.md");
const SVG_OUT = path.join(CHARTS_DIR, "chart-v128-swar-v-v128-simd.svg");
const TITLE = "v128 SWAR vs SIMD";
const SUBTITLE = chartSubtitle(ROOT);

const SUITE_SWAR = "v128";
...
const VARIANTS: Variant[] = [
  { key: "v128-swar-v8", color: "rgb(99,102,241)", runtime: "v8", mode: "swar", suite: SUITE_SWAR },
  { key: "v128-swar-wavm", color: "rgb(34,197,94)", runtime: "wavm", mode: "swar", suite: SUITE_SWAR },
  { key: "v128-simd-v8", color: "rgb(234,220,90)", runtime: "v8", mode: "simd", suite: SUITE_SIMD },
  { key: "v128-simd-wavm", color: "rgb(239,68,68)", runtime: "wavm", mode: "simd", suite: SUITE_SIMD },
];
