...
const MD_OUT = path.join(CHARTS_DIR, "chart-i8x16-swar-v-i8x16-simd.md");
const SVG_OUT = path.join(CHARTS_DIR, "chart-i8x16-swar-v-i8x16-simd.svg");
const TITLE = "i8x16 SWAR vs SIMD";
const SUBTITLE = chartSubtitle(ROOT);

const SUITE_SWAR = "i8x16";
const SUITE_SIMD = "i8x16";
const ORDER = [
...
const VARIANTS: Variant[] = [
  { key: "i8x16-swar-v8", color: "rgb(99,102,241)", runtime: "v8", mode: "swar", suite: SUITE_SWAR },
  { key: "i8x16-swar-wavm", color: "rgb(34,197,94)", runtime: "wavm", mode: "swar", suite: SUITE_SWAR },
  { key: "i8x16-simd-v8", color: "rgb(234,220,90)", runtime: "v8", mode: "simd", suite: SUITE_SIMD },
  { key: "i8x16-simd-wavm", color: "rgb(239,68,68)", runtime: "wavm", mode: "simd", suite: SUITE_SIMD },
];
